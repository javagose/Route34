...
public class InstanceIDListenerService extends Service {
    ...
    class C03771 extends Handler {
        ...
        C03771(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C03782 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C03782(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C03771(this, Looper.getMainLooper()));
        this.zzaMX = new C03782(this);
    }
