...
public final class Address {
    ...
    static class C08151 extends com.google.android.gms.common.api.Api.zza<zzpn, AddressOptions> {
        C08151() {
        }
    ...
    static class C11222 extends zza {
        ...
        C11222(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
    ...
    public static void requestUserAddress(GoogleApiClient googleApiClient, UserAddressRequest request, int requestCode) {
        googleApiClient.zza(new C11222(googleApiClient, request, requestCode));
    }
}
