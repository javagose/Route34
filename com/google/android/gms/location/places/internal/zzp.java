...
public class zzp implements PlacePhotoMetadata {
    ...
    class C13521 extends zza<zze> {
        final /* synthetic */ int zzaQT;
        final /* synthetic */ int zzaQU;
        final /* synthetic */ zzp zzaQV;

        C13521(zzp com_google_android_gms_location_places_internal_zzp, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, int i, int i2) {
    ...
    public PendingResult<PlacePhotoResult> getScaledPhoto(GoogleApiClient client, int width, int height) {
        return client.zza(new C13521(this, Places.zzaPN, client, width, height));
    }
