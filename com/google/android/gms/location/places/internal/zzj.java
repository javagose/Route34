...
public class zzj implements PlaceDetectionApi {
    ...
    class C13501 extends zzd<zzk> {
        final /* synthetic */ PlaceFilter zzaQt;
        final /* synthetic */ zzj zzaQu;

        C13501(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceFilter placeFilter) {
    ...
    class C13512 extends zzf<zzk> {
        final /* synthetic */ zzj zzaQu;
        final /* synthetic */ PlaceReport zzaQv;

        C13512(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceReport placeReport) {
            this.zzaQu = com_google_android_gms_location_places_internal_zzj;
    ...
    public PendingResult<PlaceLikelihoodBuffer> getCurrentPlace(GoogleApiClient client, PlaceFilter filter) {
        return client.zza(new C13501(this, Places.zzaPO, client, filter));
    }

    public PendingResult<Status> reportDeviceAtPlace(GoogleApiClient client, PlaceReport report) {
        return client.zzb(new C13512(this, Places.zzaPO, client, report));
    }
}
