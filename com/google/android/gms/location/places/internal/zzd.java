...
public class zzd implements GeoDataApi {
    ...
    class C13461 extends zzc<zze> {
        final /* synthetic */ AddPlaceRequest zzaQk;
        final /* synthetic */ zzd zzaQl;

        C13461(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, AddPlaceRequest addPlaceRequest) {
    ...
    class C13472 extends zzc<zze> {
        final /* synthetic */ zzd zzaQl;
        final /* synthetic */ String[] zzaQm;

        C13472(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String[] strArr) {
            this.zzaQl = com_google_android_gms_location_places_internal_zzd;
            this.zzaQm = strArr;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    class C13483 extends zza<zze> {
        final /* synthetic */ String zzaGh;
        final /* synthetic */ zzd zzaQl;
        final /* synthetic */ LatLngBounds zzaQn;
        final /* synthetic */ AutocompleteFilter zzaQo;

        C13483(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str, LatLngBounds latLngBounds, AutocompleteFilter autocompleteFilter) {
            this.zzaQl = com_google_android_gms_location_places_internal_zzd;
            this.zzaGh = str;
    ...
    class C13494 extends zzb<zze> {
        final /* synthetic */ zzd zzaQl;
        final /* synthetic */ String zzaQp;

        C13494(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str) {
            this.zzaQl = com_google_android_gms_location_places_internal_zzd;
            this.zzaQp = str;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    public PendingResult<PlaceBuffer> addPlace(GoogleApiClient client, AddPlaceRequest addPlaceRequest) {
        return client.zzb(new C13461(this, Places.zzaPN, client, addPlaceRequest));
    }
    ...
    public PendingResult<AutocompletePredictionBuffer> getAutocompletePredictions(GoogleApiClient client, String query, LatLngBounds bounds, AutocompleteFilter filter) {
        return client.zza(new C13483(this, Places.zzaPN, client, query, bounds, filter));
    }
    ...
    public PendingResult<PlaceBuffer> getPlaceById(GoogleApiClient client, String... placeIds) {
        ...
        zzx.zzac(z);
        return client.zza(new C13472(this, Places.zzaPN, client, placeIds));
    }

    public PendingResult<PlacePhotoMetadataResult> getPlacePhotos(GoogleApiClient client, String placeId) {
        return client.zza(new C13494(this, Places.zzaPN, client, placeId));
    }
}
