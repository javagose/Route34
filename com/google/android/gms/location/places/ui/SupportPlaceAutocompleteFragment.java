...
public class SupportPlaceAutocompleteFragment extends Fragment {
    ...
    class C04931 implements OnClickListener {
        ...
        C04931(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
    ...
    class C04942 implements OnClickListener {
        ...
        C04942(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
            this.zzaRo = supportPlaceAutocompleteFragment;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(C0233R.layout.place_autocomplete_fragment, container, false);
        this.zzaRh = inflate.findViewById(C0233R.id.place_autocomplete_search_button);
        this.zzaRi = inflate.findViewById(C0233R.id.place_autocomplete_clear_button);
        this.zzaRj = (EditText) inflate.findViewById(C0233R.id.place_autocomplete_search_input);
        OnClickListener c04931 = new C04931(this);
        this.zzaRh.setOnClickListener(c04931);
        this.zzaRj.setOnClickListener(c04931);
        this.zzaRi.setOnClickListener(new C04942(this));
        zzzF();
        return inflate;
    }
