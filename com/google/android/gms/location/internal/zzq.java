...
public class zzq implements SettingsApi {
    ...
    class C11371 extends zza<LocationSettingsResult> {
        final /* synthetic */ String zzaHU;
        final /* synthetic */ LocationSettingsRequest zzaPa;
        final /* synthetic */ zzq zzaPb;

        C11371(zzq com_google_android_gms_location_internal_zzq, GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
    ...
    public PendingResult<LocationSettingsResult> zza(GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
        return googleApiClient.zza(new C11371(this, googleApiClient, locationSettingsRequest, str));
    }
}
