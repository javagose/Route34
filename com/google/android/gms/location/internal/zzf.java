...
public class zzf implements GeofencingApi {
    ...
    class C13431 extends zza {
        final /* synthetic */ PendingIntent zzaAp;
        final /* synthetic */ GeofencingRequest zzaOD;
        final /* synthetic */ zzf zzaOE;

        C13431(zzf com_google_android_gms_location_internal_zzf, GoogleApiClient googleApiClient, GeofencingRequest geofencingRequest, PendingIntent pendingIntent) {
    ...
    class C13442 extends zza {
        final /* synthetic */ PendingIntent zzaAp;
        final /* synthetic */ zzf zzaOE;

        C13442(zzf com_google_android_gms_location_internal_zzf, GoogleApiClient googleApiClient, PendingIntent pendingIntent) {
            this.zzaOE = com_google_android_gms_location_internal_zzf;
            this.zzaAp = pendingIntent;
            super(googleApiClient);
        }
    ...
    class C13453 extends zza {
        final /* synthetic */ zzf zzaOE;
        final /* synthetic */ List zzaOF;

        C13453(zzf com_google_android_gms_location_internal_zzf, GoogleApiClient googleApiClient, List list) {
            this.zzaOE = com_google_android_gms_location_internal_zzf;
            this.zzaOF = list;
            super(googleApiClient);
        }
    ...
    public PendingResult<Status> addGeofences(GoogleApiClient client, GeofencingRequest geofencingRequest, PendingIntent pendingIntent) {
        return client.zzb(new C13431(this, client, geofencingRequest, pendingIntent));
    }
    ...
    public PendingResult<Status> removeGeofences(GoogleApiClient client, PendingIntent pendingIntent) {
        return client.zzb(new C13442(this, client, pendingIntent));
    }

    public PendingResult<Status> removeGeofences(GoogleApiClient client, List<String> geofenceRequestIds) {
        return client.zzb(new C13453(this, client, geofenceRequestIds));
    }
}
