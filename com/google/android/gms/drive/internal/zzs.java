...
public class zzs implements DriveApi {
    ...
    class C11165 extends zzt<BooleanResult> {
        final /* synthetic */ zzs zzaqD;

        /* renamed from: com.google.android.gms.drive.internal.zzs.5.1 */
        class C10901 extends zzd {
            final /* synthetic */ zzt zzaqG;
            final /* synthetic */ C11165 zzaqH;

            C10901(C11165 c11165, zzt com_google_android_gms_drive_internal_zzt) {
                this.zzaqH = c11165;
        ...
        C11165(zzs com_google_android_gms_drive_internal_zzs, GoogleApiClient googleApiClient) {
        ...
        protected void zza(zzu com_google_android_gms_drive_internal_zzu) throws RemoteException {
            com_google_android_gms_drive_internal_zzu.zzte().zze(new C10901(this, this));
        }
    ...
    class C11941 extends zzh {
        final /* synthetic */ Query zzaqC;
        final /* synthetic */ zzs zzaqD;

        C11941(zzs com_google_android_gms_drive_internal_zzs, GoogleApiClient googleApiClient, Query query) {
            this.zzaqD = com_google_android_gms_drive_internal_zzs;
            this.zzaqC = query;
            super(googleApiClient);
        }
    ...
    class C11952 extends zzc {
        final /* synthetic */ zzs zzaqD;
        final /* synthetic */ int zzaqE;

        C11952(zzs com_google_android_gms_drive_internal_zzs, GoogleApiClient googleApiClient, int i) {
            this.zzaqD = com_google_android_gms_drive_internal_zzs;
            this.zzaqE = i;
            super(googleApiClient);
        }
    ...
    class C11963 extends zzf {
        final /* synthetic */ zzs zzaqD;
        final /* synthetic */ String zzaqF;

        C11963(zzs com_google_android_gms_drive_internal_zzs, GoogleApiClient googleApiClient, String str) {
            this.zzaqD = com_google_android_gms_drive_internal_zzs;
            this.zzaqF = str;
            super(googleApiClient);
        }
    ...
    class C11974 extends com.google.android.gms.drive.internal.zzt.zza {
        final /* synthetic */ zzs zzaqD;

        C11974(zzs com_google_android_gms_drive_internal_zzs, GoogleApiClient googleApiClient) {
            this.zzaqD = com_google_android_gms_drive_internal_zzs;
            super(googleApiClient);
        }
    ...
    public PendingResult<DriveIdResult> fetchDriveId(GoogleApiClient apiClient, String resourceId) {
        return apiClient.zza(new C11963(this, apiClient, resourceId));
    }
    ...
    public PendingResult<BooleanResult> isAutobackupEnabled(GoogleApiClient apiClient) {
        return apiClient.zza(new C11165(this, apiClient));
    }
    ...
    public PendingResult<MetadataBufferResult> query(GoogleApiClient apiClient, Query query) {
        if (query != null) {
            return apiClient.zza(new C11941(this, apiClient, query));
        }
        throw new IllegalArgumentException("Query must be provided.");
    }

    public PendingResult<Status> requestSync(GoogleApiClient apiClient) {
        return apiClient.zzb(new C11974(this, apiClient));
    }

    public PendingResult<DriveContentsResult> zza(GoogleApiClient googleApiClient, int i) {
        return googleApiClient.zza(new C11952(this, googleApiClient, i));
    }
}
