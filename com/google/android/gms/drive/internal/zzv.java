...
public class zzv implements DriveContents {
    ...
    class C08003 implements ResultCallback<Status> {
        final /* synthetic */ zzv zzard;

        C08003(zzv com_google_android_gms_drive_internal_zzv) {
    ...
    class C12031 extends zzc {
        final /* synthetic */ zzv zzard;

        C12031(zzv com_google_android_gms_drive_internal_zzv, GoogleApiClient googleApiClient) {
            this.zzard = com_google_android_gms_drive_internal_zzv;
    ...
    class C12042 extends zza {
        final /* synthetic */ zzv zzard;
        final /* synthetic */ MetadataChangeSet zzare;
        final /* synthetic */ zzi zzarf;

        C12042(zzv com_google_android_gms_drive_internal_zzv, GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet, zzi com_google_android_gms_drive_zzi) {
            this.zzard = com_google_android_gms_drive_internal_zzv;
    ...
    class C12054 extends zza {
        final /* synthetic */ zzv zzard;

        C12054(zzv com_google_android_gms_drive_internal_zzv, GoogleApiClient googleApiClient) {
            this.zzard = com_google_android_gms_drive_internal_zzv;
            super(googleApiClient);
        }
    ...
    public void discard(GoogleApiClient apiClient) {
        ...
        zzsy();
        ((C12054) apiClient.zzb(new C12054(this, apiClient))).setResultCallback(new C08003(this));
    }
    ...
    public PendingResult<DriveContentsResult> reopenForWrite(GoogleApiClient apiClient) {
        if (zzsz()) {
            ...
            zzsy();
            return apiClient.zza(new C12031(this, apiClient));
        }
    }
    ...
    public PendingResult<Status> zza(GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet, zzi com_google_android_gms_drive_zzi) {
        ...
        if (this.zzara.getMode() == DriveFile.MODE_READ_ONLY) {
            ...
            if (zzsz()) {
                ...
                zzsy();
                return googleApiClient.zzb(new C12042(this, googleApiClient, metadataChangeSet, com_google_android_gms_drive_zzi));
            }
        } else {
