...
public class zzab implements DriveResource {
    ...
    class C11871 extends zzd {
        final /* synthetic */ boolean zzarx;
        final /* synthetic */ zzab zzary;

        C11871(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient, boolean z) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            this.zzarx = z;
    ...
    class C11882 extends zzh {
        final /* synthetic */ zzab zzary;

        C11882(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            super(googleApiClient);
        }
    ...
    class C11893 extends com.google.android.gms.drive.internal.zzt.zza {
        final /* synthetic */ zzab zzary;
        final /* synthetic */ List zzarz;

        C11893(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient, List list) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            this.zzarz = list;
            super(googleApiClient);
        }
    ...
    class C11904 extends zzd {
        final /* synthetic */ MetadataChangeSet zzarm;
        final /* synthetic */ zzab zzary;

        C11904(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
    ...
    class C11915 extends com.google.android.gms.drive.internal.zzt.zza {
        final /* synthetic */ zzab zzary;

        C11915(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            super(googleApiClient);
        }
    ...
    class C11926 extends com.google.android.gms.drive.internal.zzt.zza {
        final /* synthetic */ zzab zzary;

        C11926(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            super(googleApiClient);
        }
    ...
    class C11937 extends com.google.android.gms.drive.internal.zzt.zza {
        final /* synthetic */ zzab zzary;

        C11937(zzab com_google_android_gms_drive_internal_zzab, GoogleApiClient googleApiClient) {
            this.zzary = com_google_android_gms_drive_internal_zzab;
            super(googleApiClient);
        }
    ...
    private PendingResult<MetadataResult> zza(GoogleApiClient googleApiClient, boolean z) {
        return googleApiClient.zza(new C11871(this, googleApiClient, z));
    }
    ...
    public PendingResult<Status> delete(GoogleApiClient apiClient) {
        return apiClient.zzb(new C11915(this, apiClient));
    }
    ...
    public PendingResult<MetadataBufferResult> listParents(GoogleApiClient apiClient) {
        return apiClient.zza(new C11882(this, apiClient));
    }
