...
public class zzu extends zzj<zzam> {
    ...
    class C11981 extends zza {
        ...
        C11981(zzu com_google_android_gms_drive_internal_zzu, GoogleApiClient googleApiClient, AddEventListenerRequest addEventListenerRequest, zzae com_google_android_gms_drive_internal_zzae) {
    ...
    class C11992 extends zza {
        final /* synthetic */ zzae zzaqU;
        final /* synthetic */ zzu zzaqV;
        final /* synthetic */ RemoveEventListenerRequest zzaqW;

        C11992(zzu com_google_android_gms_drive_internal_zzu, GoogleApiClient googleApiClient, RemoveEventListenerRequest removeEventListenerRequest, zzae com_google_android_gms_drive_internal_zzae) {
            this.zzaqV = com_google_android_gms_drive_internal_zzu;
    ...
    class C12003 extends zza {
        final /* synthetic */ AddEventListenerRequest zzaqT;
        final /* synthetic */ zzu zzaqV;

        C12003(zzu com_google_android_gms_drive_internal_zzu, GoogleApiClient googleApiClient, AddEventListenerRequest addEventListenerRequest) {
            this.zzaqV = com_google_android_gms_drive_internal_zzu;
            this.zzaqT = addEventListenerRequest;
            super(googleApiClient);
        }
    ...
    class C12014 extends zza {
        final /* synthetic */ zzu zzaqV;
        final /* synthetic */ DriveId zzaqX;
        final /* synthetic */ int zzaqY;

        C12014(zzu com_google_android_gms_drive_internal_zzu, GoogleApiClient googleApiClient, DriveId driveId, int i) {
            this.zzaqV = com_google_android_gms_drive_internal_zzu;
            this.zzaqX = driveId;
            this.zzaqY = i;
            super(googleApiClient);
    ...
    class C12025 extends zza {
        final /* synthetic */ zzu zzaqV;
        final /* synthetic */ List zzaqZ;

        C12025(zzu com_google_android_gms_drive_internal_zzu, GoogleApiClient googleApiClient, List list) {
            this.zzaqV = com_google_android_gms_drive_internal_zzu;
            this.zzaqZ = list;
            super(googleApiClient);
        }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, int i, DriveId driveId) {
        ...
        return googleApiClient.zzb(new C12014(this, googleApiClient, driveId, i));
    }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, AddEventListenerRequest addEventListenerRequest) {
        ...
        zzx.zza(isConnected(), (Object) "Client must be connected");
        if (this.zzaqL) {
            return googleApiClient.zzb(new C12003(this, googleApiClient, addEventListenerRequest));
        }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, AddEventListenerRequest addEventListenerRequest, zzae com_google_android_gms_drive_internal_zzae) {
        return googleApiClient.zzb(new C11981(this, googleApiClient, addEventListenerRequest, com_google_android_gms_drive_internal_zzae));
    }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, RemoveEventListenerRequest removeEventListenerRequest, zzae com_google_android_gms_drive_internal_zzae) {
        return googleApiClient.zzb(new C11992(this, googleApiClient, removeEventListenerRequest, com_google_android_gms_drive_internal_zzae));
    }
    ...
    PendingResult<Status> cancelPendingActions(GoogleApiClient apiClient, List<String> pendingTags) {
        ...
        zzx.zzac(z);
        zzx.zza(isConnected(), (Object) "Client must be connected");
        return apiClient.zzb(new C12025(this, apiClient, pendingTags));
    }
