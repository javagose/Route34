...
public class zzy extends zzab implements DriveFolder {
    ...
    class C12071 extends zzd {
        ...
        C12071(zzy com_google_android_gms_drive_internal_zzy, GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet, int i, int i2, zzh com_google_android_gms_drive_zzh) {
    ...
    class C12082 extends zzf {
        final /* synthetic */ MetadataChangeSet zzarm;
        final /* synthetic */ zzy zzarq;

        C12082(zzy com_google_android_gms_drive_internal_zzy, GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet) {
            this.zzarq = com_google_android_gms_drive_internal_zzy;
            this.zzarm = metadataChangeSet;
            super(googleApiClient);
        }
    ...
    private PendingResult<DriveFileResult> zza(GoogleApiClient googleApiClient, MetadataChangeSet metadataChangeSet, int i, zzh com_google_android_gms_drive_zzh) {
        ...
        return googleApiClient.zzb(new C12071(this, googleApiClient, metadataChangeSet, i, i2, com_google_android_gms_drive_zzh));
    }
    ...
    public PendingResult<DriveFolderResult> createFolder(GoogleApiClient apiClient, MetadataChangeSet changeSet) {
        if (changeSet == null) {
            ...
            return apiClient.zzb(new C12082(this, apiClient, changeSet));
        } else {
