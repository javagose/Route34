...
public final class Drive {
    ...
    static class C09991 extends zza<NoOptions> {
        C09991() {
        }
    ...
    static class C10002 extends zza<zzb> {
        C10002() {
        }
    ...
    static {
        ...
        API = new Api("Drive.API", new C09991(), zzUI);
        zzaoG = new Api("Drive.INTERNAL_API", new C10002(), zzUI);
        DriveApi = new zzs();
        zzaoH = new zzx();
        zzaoI = new zzac();
