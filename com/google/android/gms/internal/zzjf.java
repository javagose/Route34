...
public class zzjf {
    ...
    static class C04631 implements Runnable {
        final /* synthetic */ zzjd zzNf;
        final /* synthetic */ zza zzNg;
        final /* synthetic */ zzjg zzNh;

        C04631(zzjd com_google_android_gms_internal_zzjd, zza com_google_android_gms_internal_zzjf_zza, zzjg com_google_android_gms_internal_zzjg) {
    ...
    static class C04642 implements Runnable {
        final /* synthetic */ AtomicInteger zzNi;
        final /* synthetic */ int zzNj;
        final /* synthetic */ zzjd zzNk;
        final /* synthetic */ List zzNl;

        C04642(AtomicInteger atomicInteger, int i, zzjd com_google_android_gms_internal_zzjd, List list) {
    ...
    public static <A, B> zzjg<B> zza(zzjg<A> com_google_android_gms_internal_zzjg_A, zza<A, B> com_google_android_gms_internal_zzjf_zza_A__B) {
        ...
        com_google_android_gms_internal_zzjg_A.zzb(new C04631(com_google_android_gms_internal_zzjd, com_google_android_gms_internal_zzjf_zza_A__B, com_google_android_gms_internal_zzjg_A));
    ...
    public static <V> zzjg<List<V>> zzl(List<zzjg<V>> list) {
        ...
        for (zzjg zzb : list) {
            zzb.zzb(new C04642(atomicInteger, size, com_google_android_gms_internal_zzjd, list));
        }
        return com_google_android_gms_internal_zzjd;
    }
