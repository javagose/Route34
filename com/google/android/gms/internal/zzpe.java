...
public class zzpe implements RecordingApi {
    ...
    class C11311 extends zza<ListSubscriptionsResult> {
        final /* synthetic */ zzpe zzaAe;

        C11311(zzpe com_google_android_gms_internal_zzpe, GoogleApiClient googleApiClient) {
    ...
    class C11322 extends zza<ListSubscriptionsResult> {
        final /* synthetic */ DataType zzaAa;
        final /* synthetic */ zzpe zzaAe;

        C11322(zzpe com_google_android_gms_internal_zzpe, GoogleApiClient googleApiClient, DataType dataType) {
            this.zzaAe = com_google_android_gms_internal_zzpe;
            this.zzaAa = dataType;
            super(googleApiClient);
        }
    ...
    class C12983 extends zzc {
        final /* synthetic */ zzpe zzaAe;
        final /* synthetic */ Subscription zzaAf;

        C12983(zzpe com_google_android_gms_internal_zzpe, GoogleApiClient googleApiClient, Subscription subscription) {
            this.zzaAe = com_google_android_gms_internal_zzpe;
    ...
    class C12994 extends zzc {
        final /* synthetic */ DataType zzaAa;
        final /* synthetic */ zzpe zzaAe;

        C12994(zzpe com_google_android_gms_internal_zzpe, GoogleApiClient googleApiClient, DataType dataType) {
            this.zzaAe = com_google_android_gms_internal_zzpe;
            this.zzaAa = dataType;
            super(googleApiClient);
        }
    ...
    class C13005 extends zzc {
        final /* synthetic */ zzpe zzaAe;
        final /* synthetic */ DataSource zzaAg;

        C13005(zzpe com_google_android_gms_internal_zzpe, GoogleApiClient googleApiClient, DataSource dataSource) {
            this.zzaAe = com_google_android_gms_internal_zzpe;
    ...
    public PendingResult<Status> unsubscribe(GoogleApiClient client, DataSource dataSource) {
        return client.zzb(new C13005(this, client, dataSource));
    }

    public PendingResult<Status> unsubscribe(GoogleApiClient client, DataType dataType) {
        return client.zzb(new C12994(this, client, dataType));
    }
