...
public final class zzhf {
    ...
    class C08781 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C08781(zzhf com_google_android_gms_internal_zzhf) {
    ...
    class C08792 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C08792(zzhf com_google_android_gms_internal_zzhf) {
            this.zzJm = com_google_android_gms_internal_zzhf;
        }
    ...
    public zzhf(String str, String str2) {
        ...
        this.zzJi = new zzjd();
        this.zzJk = new C08781(this);
        this.zzJl = new C08792(this);
        this.zzJh = str2;
        this.zzEY = str;
    }
