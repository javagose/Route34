...
public class zzlq implements CastRemoteDisplayApi {
    ...
    class C10571 extends com.google.android.gms.internal.zzlu.zza {
        final /* synthetic */ zzlq zzaeH;

        C10571(zzlq com_google_android_gms_internal_zzlq) {
    ...
    class C11242 extends zzb {
        final /* synthetic */ zzlq zzaeH;
        final /* synthetic */ String zzaeI;

        C11242(zzlq com_google_android_gms_internal_zzlq, GoogleApiClient googleApiClient, String str) {
            this.zzaeH = com_google_android_gms_internal_zzlq;
            this.zzaeI = str;
    ...
    class C11253 extends zzb {
        final /* synthetic */ zzlq zzaeH;

        C11253(zzlq com_google_android_gms_internal_zzlq, GoogleApiClient googleApiClient) {
            this.zzaeH = com_google_android_gms_internal_zzlq;
            super(com_google_android_gms_internal_zzlq, googleApiClient);
        }
    ...
    public PendingResult<CastRemoteDisplaySessionResult> startRemoteDisplay(GoogleApiClient apiClient, String appId) {
        ...
        return apiClient.zzb(new C11242(this, apiClient, appId));
    }
    ...
    public PendingResult<CastRemoteDisplaySessionResult> stopRemoteDisplay(GoogleApiClient apiClient) {
        ...
        return apiClient.zzb(new C11253(this, apiClient));
    }
}
