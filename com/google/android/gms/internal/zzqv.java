...
public final class zzqv implements Account {
    ...
    class C13141 extends zza {
        final /* synthetic */ zzqv zzbey;

        C13141(zzqv com_google_android_gms_internal_zzqv, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> revokeAccessAndDisconnect(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C13141(this, googleApiClient));
    }
}
