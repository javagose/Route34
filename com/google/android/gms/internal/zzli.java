...
public class zzli extends com.google.android.gms.cast.internal.zzc {
    ...
    class C08844 implements ResultCallback<Status> {
        final /* synthetic */ zzli zzacN;
        final /* synthetic */ long zzacS;

        C08844(zzli com_google_android_gms_internal_zzli, long j) {
    ...
    public abstract class zza extends zzb<GameManagerResult> {
        ...
        class C08851 implements zzo {
            final /* synthetic */ zzli zzacT;
            final /* synthetic */ zza zzacU;

            C08851(zza com_google_android_gms_internal_zzli_zza, zzli com_google_android_gms_internal_zzli) {
        ...
        public zza(zzli com_google_android_gms_internal_zzli) {
            ...
            this.zzacm = new C08851(this, com_google_android_gms_internal_zzli);
        }
    ...
    public abstract class zzc extends zzb<GameManagerInstanceResult> {
        ...
        class C08861 implements zzo {
            final /* synthetic */ zzli zzacT;
            final /* synthetic */ zzc zzacW;

            C08861(zzc com_google_android_gms_internal_zzli_zzc, zzli com_google_android_gms_internal_zzli) {
        ...
        public zzc(zzli com_google_android_gms_internal_zzli, GameManagerClient gameManagerClient) {
            ...
            super(com_google_android_gms_internal_zzli);
            this.zzacV = gameManagerClient;
            this.zzacm = new C08861(this, com_google_android_gms_internal_zzli);
        }
    ...
    class C13531 extends zzc {
        final /* synthetic */ zzli zzacN;

        /* renamed from: com.google.android.gms.internal.zzli.1.1 */
        class C08831 implements MessageReceivedCallback {
            final /* synthetic */ C13531 zzacO;

            C08831(C13531 c13531) {
                this.zzacO = c13531;
            }
        ...
        C13531(zzli com_google_android_gms_internal_zzli, GameManagerClient gameManagerClient) {
            this.zzacN = com_google_android_gms_internal_zzli;
        ...
        public void execute() {
            try {
                this.zzacN.zzacC.setMessageReceivedCallbacks(this.zzacN.zzacD, this.zzacN.getNamespace(), new C08831(this));
                this.zzacN.zznU();
                this.zzacN.zznT();
    ...
    class C13542 extends zza {
        final /* synthetic */ zzli zzacN;
        final /* synthetic */ int zzacP;
        final /* synthetic */ String zzacQ;
        final /* synthetic */ JSONObject zzacR;

        C13542(zzli com_google_android_gms_internal_zzli, int i, String str, JSONObject jSONObject) {
            this.zzacN = com_google_android_gms_internal_zzli;
            this.zzacP = i;
            this.zzacQ = str;
    ...
    class C13553 extends zza {
        final /* synthetic */ zzli zzacN;
        final /* synthetic */ String zzacQ;
        final /* synthetic */ JSONObject zzacR;

        C13553(zzli com_google_android_gms_internal_zzli, String str, JSONObject jSONObject) {
            this.zzacN = com_google_android_gms_internal_zzli;
            this.zzacQ = str;
            this.zzacR = jSONObject;
            super(com_google_android_gms_internal_zzli);
    ...
    private void zza(String str, int i, JSONObject jSONObject, zzo com_google_android_gms_cast_internal_zzo) {
        ...
        zzW(true);
        this.zzacC.sendMessage(this.zzacD, getNamespace(), zza.toString()).setResultCallback(new C08844(this, j));
    }
    ...
    public synchronized PendingResult<GameManagerResult> sendGameRequest(String playerId, JSONObject extraMessageData) throws IllegalStateException {
        zznR();
        return this.zzacD.zzb(new C13553(this, playerId, extraMessageData));
    }
    ...
    public synchronized PendingResult<GameManagerInstanceResult> zza(GameManagerClient gameManagerClient) throws IllegalArgumentException {
        ...
        return this.zzacD.zzb(new C13531(this, gameManagerClient));
    }
    ...
    public synchronized PendingResult<GameManagerResult> zza(String str, int i, JSONObject jSONObject) throws IllegalStateException {
        zznR();
        return this.zzacD.zzb(new C13542(this, i, str, jSONObject));
    }
