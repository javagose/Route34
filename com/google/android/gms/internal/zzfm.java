...
public class zzfm extends zzfs {
    ...
    class C04261 implements OnClickListener {
        ...
        C04261(zzfm com_google_android_gms_internal_zzfm) {
    ...
    class C04272 implements OnClickListener {
        ...
        C04272(zzfm com_google_android_gms_internal_zzfm) {
            this.zzCZ = com_google_android_gms_internal_zzfm;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzL.setTitle(zzr.zzbF().zzd(C0233R.string.create_calendar_title, "Create calendar event"));
            zzL.setMessage(zzr.zzbF().zzd(C0233R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzL.setPositiveButton(zzr.zzbF().zzd(C0233R.string.accept, "Accept"), new C04261(this));
            zzL.setNegativeButton(zzr.zzbF().zzd(C0233R.string.decline, "Decline"), new C04272(this));
            zzL.create().show();
        } else {
