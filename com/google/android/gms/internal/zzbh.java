...
public class zzbh {
    ...
    class C03861 implements Comparator<String> {
        final /* synthetic */ zzbh zztt;

        C03861(zzbh com_google_android_gms_internal_zzbh) {
    ...
    class C03872 implements Comparator<com.google.android.gms.internal.zzbk.zza> {
        final /* synthetic */ zzbh zztt;

        C03872(zzbh com_google_android_gms_internal_zzbh) {
            this.zztt = com_google_android_gms_internal_zzbh;
        }
    ...
    private String zzv(String str) {
        ...
        zza zzcM = zzcM();
        Arrays.sort(split, new C03861(this));
        int i = 0;
    ...
    String zzw(String str) {
        ...
        zza zzcM = zzcM();
        PriorityQueue priorityQueue = new PriorityQueue(this.zztq, new C03872(this));
