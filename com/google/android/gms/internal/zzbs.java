...
public class zzbs {
    ...
    class C03881 implements Callable<T> {
        final /* synthetic */ zzbp zzvy;
        final /* synthetic */ zzbs zzvz;

        C03881(zzbs com_google_android_gms_internal_zzbs, zzbp com_google_android_gms_internal_zzbp) {
    ...
    public <T> T zzd(zzbp<T> com_google_android_gms_internal_zzbp_T) {
        synchronized (this.zzpV) {
            if (this.zzqA) {
                return zzjb.zzb(new C03881(this, com_google_android_gms_internal_zzbp_T));
            }
