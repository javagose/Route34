...
public class zzgw implements Callable<zzif> {
    ...
    class C04392 implements Runnable {
        ...
        C04392(zzgw com_google_android_gms_internal_zzgw, zzjd com_google_android_gms_internal_zzjd, String str) {
    ...
    class C08701 implements zzdf {
        final /* synthetic */ zzed zzGM;
        final /* synthetic */ zzb zzGN;
        final /* synthetic */ zzjd zzGO;
        final /* synthetic */ zzgw zzGP;

        C08701(zzgw com_google_android_gms_internal_zzgw, zzed com_google_android_gms_internal_zzed, zzb com_google_android_gms_internal_zzgw_zzb, zzjd com_google_android_gms_internal_zzjd) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class C08713 implements zzdf {
        final /* synthetic */ zzgw zzGP;
        final /* synthetic */ zzf zzGS;

        C08713(zzgw com_google_android_gms_internal_zzgw, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class C08724 implements com.google.android.gms.internal.zzjf.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgw zzGP;
        ...
        C08724(zzgw com_google_android_gms_internal_zzgw, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGT = str;
            this.zzGU = num;
            this.zzGV = num2;
    ...
    class C08735 implements com.google.android.gms.internal.zziw.zza<zzc> {
        final /* synthetic */ String zzDr;
        final /* synthetic */ zzgw zzGP;
        final /* synthetic */ boolean zzGZ;
        final /* synthetic */ double zzHa;

        C08735(zzgw com_google_android_gms_internal_zzgw, boolean z, double d, String str) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGZ = z;
            this.zzHa = d;
            this.zzDr = str;
    ...
    private zzjg<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzje(new zzc(null, Uri.parse(string), optDouble)) : this.zzGG.zza(string, new C08735(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzed com_google_android_gms_internal_zzed) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdf c08713 = new C08713(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgw_zzb.zzHb = c08713;
            com_google_android_gms_internal_zzed.zza("/nativeAdCustomClick", c08713);
        }
    }
    ...
    private JSONObject zzb(zzed com_google_android_gms_internal_zzed) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgw_zzb = new zzb(this);
        zzdf c08701 = new C08701(this, com_google_android_gms_internal_zzed, com_google_android_gms_internal_zzgw_zzb, com_google_android_gms_internal_zzjd);
        com_google_android_gms_internal_zzgw_zzb.zzHb = c08701;
        com_google_android_gms_internal_zzed.zza("/nativeAdPreProcess", c08701);
    ...
    protected zza zze(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzjd com_google_android_gms_internal_zzjd = new zzjd();
            zzir.zzMc.post(new C04392(this, com_google_android_gms_internal_zzjd, string2));
    ...
    public zzjg<com.google.android.gms.ads.internal.formats.zza> zzf(JSONObject jSONObject) throws JSONException {
        ...
        return zzjf.zza(zzjf.zzl(arrayList), new C08724(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
