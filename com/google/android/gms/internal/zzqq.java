...
public class zzqq implements PanoramaApi {
    ...
    static class C10623 extends com.google.android.gms.internal.zzqo.zza {
        final /* synthetic */ Uri zzbds;
        final /* synthetic */ zzqo zzbdu;
        final /* synthetic */ Context zzxh;

        C10623(Context context, Uri uri, zzqo com_google_android_gms_internal_zzqo) {
            this.zzxh = context;
            this.zzbds = uri;
    ...
    class C13121 extends zza {
        final /* synthetic */ Uri zzbds;
        final /* synthetic */ zzqq zzbdt;

        C13121(zzqq com_google_android_gms_internal_zzqq, GoogleApiClient googleApiClient, Uri uri) {
    ...
    class C13132 extends zza {
        final /* synthetic */ Uri zzbds;
        final /* synthetic */ zzqq zzbdt;

        C13132(zzqq com_google_android_gms_internal_zzqq, GoogleApiClient googleApiClient, Uri uri) {
            this.zzbdt = com_google_android_gms_internal_zzqq;
            this.zzbds = uri;
            super(googleApiClient);
        }
    ...
    private static void zza(Context context, zzqp com_google_android_gms_internal_zzqp, zzqo com_google_android_gms_internal_zzqo, Uri uri, Bundle bundle) throws RemoteException {
        ...
        try {
            com_google_android_gms_internal_zzqp.zza(new C10623(context, uri, com_google_android_gms_internal_zzqo), uri, bundle, true);
