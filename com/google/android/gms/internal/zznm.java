...
public class zznm {
    ...
    static class C11031 extends com.google.android.gms.drive.metadata.internal.zzb {
        C11031(String str, Collection collection, Collection collection2, int i) {
    ...
    static class C11042 extends zzk<BitmapTeleporter> {
        C11042(String str, Collection collection, Collection collection2, int i) {
            super(str, collection, collection2, i);
        }
    ...
    static {
        ...
        zzath = new C11031("isExplicitlyTrashed", Collections.singleton("trashed"), Collections.emptySet(), 7000000);
        ...
        zzatz = new C11042("thumbnail", Collections.emptySet(), Collections.emptySet(), 4400000);
