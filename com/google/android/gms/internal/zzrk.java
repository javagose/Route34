...
public class zzrk implements SearchAuthApi {
    ...
    static class zzb extends com.google.android.gms.common.api.internal.zza.zza<Status, zzrj> {
        ...
        class C11071 extends zza {
            ...
            C11071(zzb com_google_android_gms_internal_zzrk_zzb) {
        ...
        protected void zza(zzrj com_google_android_gms_internal_zzrj) throws RemoteException {
            ...
            ((zzri) com_google_android_gms_internal_zzrj.zzqJ()).zzb(new C11071(this), this.zzbgJ, this.zzXI);
        }
    ...
    static class zzc extends com.google.android.gms.common.api.internal.zza.zza<GoogleNowAuthResult, zzrj> {
        ...
        class C11081 extends zza {
            ...
            C11081(zzc com_google_android_gms_internal_zzrk_zzc) {
        ...
        protected void zza(zzrj com_google_android_gms_internal_zzrj) throws RemoteException {
            ...
            ((zzri) com_google_android_gms_internal_zzrj.zzqJ()).zza(new C11081(this), this.zzbgJ, this.zzbgM);
        }
