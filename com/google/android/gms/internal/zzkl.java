...
public class zzkl implements AppInviteApi {
    ...
    final class zzc extends zzb<Status> {
        ...
        class C10991 extends zza {
            final /* synthetic */ zzc zzUQ;

            C10991(zzc com_google_android_gms_internal_zzkl_zzc) {
        ...
        protected void zza(zzkm com_google_android_gms_internal_zzkm) throws RemoteException {
            com_google_android_gms_internal_zzkm.zzb(new C10991(this), this.zzUO);
        }
    ...
    final class zzd extends zzb<Status> {
        ...
        class C11001 extends zza {
            ...
            C11001(zzd com_google_android_gms_internal_zzkl_zzd) {
        ...
        protected void zza(zzkm com_google_android_gms_internal_zzkm) throws RemoteException {
            com_google_android_gms_internal_zzkm.zza(new C11001(this), this.zzUO);
        }
    ...
    final class zze extends zzb<AppInviteInvitationResult> {
        ...
        class C11011 extends zza {
            ...
            C11011(zze com_google_android_gms_internal_zzkl_zze) {
        ...
        protected void zza(zzkm com_google_android_gms_internal_zzkm) throws RemoteException {
            if (AppInviteReferral.hasReferral(this.zzUU)) {
                ...
                com_google_android_gms_internal_zzkm.zza(new C11011(this));
            }
        }
