...
public class zzpc implements HistoryApi {
    ...
    class C11294 extends zza<DataReadResult> {
        final /* synthetic */ zzpc zzazW;
        final /* synthetic */ DataReadRequest zzazZ;

        C11294(zzpc com_google_android_gms_internal_zzpc, GoogleApiClient googleApiClient, DataReadRequest dataReadRequest) {
    ...
    class C11305 extends zza<DailyTotalResult> {
        final /* synthetic */ DataType zzaAa;
        final /* synthetic */ zzpc zzazW;

        /* renamed from: com.google.android.gms.internal.zzpc.5.1 */
        class C10601 extends com.google.android.gms.internal.zzog.zza {
            final /* synthetic */ C11305 zzaAb;

            C10601(C11305 c11305) {
                this.zzaAb = c11305;
            }
        ...
        C11305(zzpc com_google_android_gms_internal_zzpc, GoogleApiClient googleApiClient, DataType dataType) {
            this.zzazW = com_google_android_gms_internal_zzpc;
            this.zzaAa = dataType;
            super(googleApiClient);
        }
        ...
        protected void zza(zzob com_google_android_gms_internal_zzob) throws RemoteException {
            ((zzom) com_google_android_gms_internal_zzob.zzqJ()).zza(new DailyTotalRequest(new C10601(this), this.zzaAa));
        }
    ...
    class C12951 extends zzc {
        final /* synthetic */ DataSet zzazU;
        final /* synthetic */ boolean zzazV;
        final /* synthetic */ zzpc zzazW;

        C12951(zzpc com_google_android_gms_internal_zzpc, GoogleApiClient googleApiClient, DataSet dataSet, boolean z) {
            this.zzazW = com_google_android_gms_internal_zzpc;
            this.zzazU = dataSet;
            this.zzazV = z;
            super(googleApiClient);
    ...
    class C12962 extends zzc {
        final /* synthetic */ zzpc zzazW;
        final /* synthetic */ DataDeleteRequest zzazX;

        C12962(zzpc com_google_android_gms_internal_zzpc, GoogleApiClient googleApiClient, DataDeleteRequest dataDeleteRequest) {
            this.zzazW = com_google_android_gms_internal_zzpc;
    ...
    class C12973 extends zzc {
        final /* synthetic */ zzpc zzazW;
        final /* synthetic */ DataUpdateRequest zzazY;

        C12973(zzpc com_google_android_gms_internal_zzpc, GoogleApiClient googleApiClient, DataUpdateRequest dataUpdateRequest) {
            this.zzazW = com_google_android_gms_internal_zzpc;
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, DataSet dataSet, boolean z) {
        ...
        return googleApiClient.zza(new C12951(this, googleApiClient, dataSet, z));
    }

    public PendingResult<Status> deleteData(GoogleApiClient client, DataDeleteRequest request) {
        return client.zza(new C12962(this, client, request));
    }
    ...
    public PendingResult<DailyTotalResult> readDailyTotal(GoogleApiClient client, DataType dataType) {
        return client.zza(new C11305(this, client, dataType));
    }

    public PendingResult<DataReadResult> readData(GoogleApiClient client, DataReadRequest request) {
        return client.zza(new C11294(this, client, request));
    }
    ...
    public PendingResult<Status> updateData(GoogleApiClient client, DataUpdateRequest request) {
        ...
        return client.zza(new C12973(this, client, request));
    }
}
