...
public class zzdg implements zzdf {
    ...
    class C03931 implements Runnable {
        ...
        class C03921 implements Runnable {
            ...
            final /* synthetic */ C03931 zzzo;

            C03921(C03931 c03931, JSONObject jSONObject) {
                this.zzzo = c03931;
        ...
        C03931(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void run() {
            ...
            if (zzQ == null) {
                ...
                zzir.zzMc.post(new C03921(this, zzQ));
            }
        }
    }
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new C03931(this, map, com_google_android_gms_internal_zzjp));
    }
