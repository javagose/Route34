...
public class zzlh extends zzlg {
    ...
    class C04751 implements InvocationHandler {
        final /* synthetic */ Class zzYk;
        final /* synthetic */ zzlh zzYl;

        C04751(zzlh com_google_android_gms_internal_zzlh, Class cls) {
    ...
    private Object zznw() throws ClassNotFoundException {
        ...
        return Proxy.newProxyInstance(Class.forName("com.facebook.Session$StatusCallback").getClassLoader(), new Class[]{r1}, new C04751(this, cls));
    }
