...
public final class zzqy implements Moments {
    ...
    private static abstract class zza extends com.google.android.gms.plus.Plus.zza<LoadMomentsResult> {
        ...
        class C10631 implements LoadMomentsResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ zza zzbeG;

            C10631(zza com_google_android_gms_internal_zzqy_zza, Status status) {
    ...
    class C13151 extends zza {
        final /* synthetic */ zzqy zzbez;

        C13151(zzqy com_google_android_gms_internal_zzqy, GoogleApiClient googleApiClient) {
    ...
    class C13162 extends zza {
        ...
        C13162(zzqy com_google_android_gms_internal_zzqy, GoogleApiClient googleApiClient, int i, String str, Uri uri, String str2, String str3) {
            this.zzbez = com_google_android_gms_internal_zzqy;
            this.zzaGt = i;
            this.zzbeA = str;
            this.zzbeB = uri;
    ...
    class C13173 extends zzc {
        final /* synthetic */ Moment zzbeE;
        final /* synthetic */ zzqy zzbez;

        C13173(zzqy com_google_android_gms_internal_zzqy, GoogleApiClient googleApiClient, Moment moment) {
            this.zzbez = com_google_android_gms_internal_zzqy;
            this.zzbeE = moment;
            super(null);
        }
    ...
    class C13184 extends zzb {
        final /* synthetic */ String zzbeF;
        final /* synthetic */ zzqy zzbez;

        C13184(zzqy com_google_android_gms_internal_zzqy, GoogleApiClient googleApiClient, String str) {
            this.zzbez = com_google_android_gms_internal_zzqy;
            this.zzbeF = str;
            super(null);
        }
    ...
    public PendingResult<LoadMomentsResult> load(GoogleApiClient googleApiClient) {
        return googleApiClient.zza(new C13151(this, googleApiClient));
    }
    ...
    public PendingResult<LoadMomentsResult> load(GoogleApiClient googleApiClient, int maxResults, String pageToken, Uri targetUrl, String type, String userId) {
        return googleApiClient.zza(new C13162(this, googleApiClient, maxResults, pageToken, targetUrl, type, userId));
    }

    @SuppressLint({"MissingRemoteException"})
    public PendingResult<Status> remove(GoogleApiClient googleApiClient, String momentId) {
        return googleApiClient.zzb(new C13184(this, googleApiClient, momentId));
    }

    @SuppressLint({"MissingRemoteException"})
    public PendingResult<Status> write(GoogleApiClient googleApiClient, Moment moment) {
        return googleApiClient.zzb(new C13173(this, googleApiClient, moment));
    }
}
