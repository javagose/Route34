...
public final class zzmh implements zzmg {
    ...
    class C12881 extends zza {
        final /* synthetic */ zzmh zzamB;

        C12881(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C12881(this, googleApiClient));
    }
}
