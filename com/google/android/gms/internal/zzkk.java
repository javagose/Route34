...
public final class zzkk implements zzk, AppIndexApi {
    ...
    class C12871 extends zzc<Status> {
        final /* synthetic */ String zzUA;
        final /* synthetic */ UsageInfo[] zzUB;
        final /* synthetic */ zzkk zzUC;

        C12871(zzkk com_google_android_gms_internal_zzkk, GoogleApiClient googleApiClient, String str, UsageInfo[] usageInfoArr) {
    ...
    public PendingResult<Status> zza(GoogleApiClient googleApiClient, UsageInfo... usageInfoArr) {
        return googleApiClient.zza(new C12871(this, googleApiClient, googleApiClient.getContext().getPackageName(), usageInfoArr));
    }
}
