...
public class zzre implements SafetyNetApi {
    ...
    static abstract class zzb extends zzrb<AttestationResult> {
        ...
        class C11051 extends zzra {
            final /* synthetic */ zzb zzbgD;

            C11051(zzb com_google_android_gms_internal_zzre_zzb) {
    ...
    static abstract class zzc extends zzrb<SafeBrowsingResult> {
        ...
        class C11061 extends zzra {
            final /* synthetic */ zzc zzbgE;

            C11061(zzc com_google_android_gms_internal_zzre_zzc) {
    ...
    class C13241 extends zzb {
        ...
        C13241(zzre com_google_android_gms_internal_zzre, GoogleApiClient googleApiClient, byte[] bArr) {
    ...
    class C13252 extends zzc {
        final /* synthetic */ String zzbgA;
        final /* synthetic */ zzre zzbgy;
        final /* synthetic */ List zzbgz;

        C13252(zzre com_google_android_gms_internal_zzre, GoogleApiClient googleApiClient, List list, String str) {
            this.zzbgy = com_google_android_gms_internal_zzre;
            this.zzbgz = list;
            this.zzbgA = str;
            super(googleApiClient);
    ...
    public PendingResult<AttestationResult> attest(GoogleApiClient googleApiClient, byte[] nonce) {
        return googleApiClient.zza(new C13241(this, googleApiClient, nonce));
    }
    ...
    public PendingResult<SafeBrowsingResult> lookupUri(GoogleApiClient googleApiClient, List<Integer> threatTypes, String uri) {
        if (threatTypes == null) {
            ...
            return googleApiClient.zza(new C13252(this, googleApiClient, threatTypes, uri));
        } else {
