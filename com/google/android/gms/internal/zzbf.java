...
public class zzbf extends Thread {
    ...
    class C03831 implements Runnable {
        ...
        C03831(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class C03852 implements Runnable {
        ...
        class C03841 implements ValueCallback<String> {
            final /* synthetic */ C03852 zztl;

            C03841(C03852 c03852) {
                this.zztl = c03852;
            }
        ...
        C03852(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new C03841(this);
        }
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new C03852(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
    ...
    boolean zze(View view) {
        ...
        view.post(new C03831(this, view));
        return true;
    }
