...
public abstract class zzbp<T> {
    ...
    static class C08251 extends zzbp<Boolean> {
        C08251(int i, String str, Boolean bool) {
            super(str, bool, null);
        }
    ...
    static class C08262 extends zzbp<Integer> {
        C08262(int i, String str, Integer num) {
            super(str, num, null);
        }
    ...
    static class C08273 extends zzbp<Long> {
        C08273(int i, String str, Long l) {
            super(str, l, null);
        }
    ...
    static class C08284 extends zzbp<String> {
        C08284(int i, String str, String str2) {
            super(str, str2, null);
        }
