...
public class zzpf implements SensorsApi {
    ...
    class C08953 implements zza {
        final /* synthetic */ zzpf zzaAi;
        final /* synthetic */ OnDataPointListener zzaAm;

        C08953(zzpf com_google_android_gms_internal_zzpf, OnDataPointListener onDataPointListener) {
    ...
    class C11331 extends zza<DataSourcesResult> {
        final /* synthetic */ DataSourcesRequest zzaAh;
        final /* synthetic */ zzpf zzaAi;

        C11331(zzpf com_google_android_gms_internal_zzpf, GoogleApiClient googleApiClient, DataSourcesRequest dataSourcesRequest) {
            this.zzaAi = com_google_android_gms_internal_zzpf;
    ...
    class C13012 extends zzc {
        final /* synthetic */ zzpf zzaAi;
        final /* synthetic */ SensorRequest zzaAj;
        final /* synthetic */ zzk zzaAk;
        final /* synthetic */ PendingIntent zzaAl;

        C13012(zzpf com_google_android_gms_internal_zzpf, GoogleApiClient googleApiClient, SensorRequest sensorRequest, zzk com_google_android_gms_fitness_data_zzk, PendingIntent pendingIntent) {
            this.zzaAi = com_google_android_gms_internal_zzpf;
    ...
    class C13024 extends zzc {
        final /* synthetic */ zzpf zzaAi;
        final /* synthetic */ zza zzaAn;
        final /* synthetic */ zzk zzaAo;
        final /* synthetic */ PendingIntent zzaAp;

        C13024(zzpf com_google_android_gms_internal_zzpf, GoogleApiClient googleApiClient, zza com_google_android_gms_internal_zzpf_zza, zzk com_google_android_gms_fitness_data_zzk, PendingIntent pendingIntent) {
            this.zzaAi = com_google_android_gms_internal_zzpf;
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, zzk com_google_android_gms_fitness_data_zzk, PendingIntent pendingIntent, zza com_google_android_gms_internal_zzpf_zza) {
        return googleApiClient.zzb(new C13024(this, googleApiClient, com_google_android_gms_internal_zzpf_zza, com_google_android_gms_fitness_data_zzk, pendingIntent));
    }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, SensorRequest sensorRequest, zzk com_google_android_gms_fitness_data_zzk, PendingIntent pendingIntent) {
        return googleApiClient.zza(new C13012(this, googleApiClient, sensorRequest, com_google_android_gms_fitness_data_zzk, pendingIntent));
    }
    ...
    public PendingResult<DataSourcesResult> findDataSources(GoogleApiClient client, DataSourcesRequest request) {
        return client.zza(new C11331(this, client, request));
    }
    ...
    public PendingResult<Status> remove(GoogleApiClient client, OnDataPointListener listener) {
        ...
        return zzb == null ? PendingResults.zza(Status.zzagC, client) : zza(client, zzb, null, new C08953(this, listener));
    }
}
