...
public class zziu {
    ...
    class C04591 implements OnClickListener {
        ...
        C04591(zziu com_google_android_gms_internal_zziu, String str) {
    ...
    class C04602 implements OnClickListener {
        ...
        C04602(zziu com_google_android_gms_internal_zziu) {
            this.zzMm = com_google_android_gms_internal_zziu;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C04591(this, zzaG));
            builder.setNegativeButton("Close", new C04602(this));
            builder.create().show();
            return;
        }
