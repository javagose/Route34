...
public class zzjv extends WebChromeClient {
    ...
    static class C04671 implements OnCancelListener {
        final /* synthetic */ JsResult zzOh;

        C04671(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04682 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C04682(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04693 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C04693(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04704 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzOi;

        C04704(JsPromptResult jsPromptResult) {
    ...
    static class C04715 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;

        C04715(JsPromptResult jsPromptResult) {
            this.zzOi = jsPromptResult;
        }
    ...
    static class C04726 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;
        final /* synthetic */ EditText zzOj;

        C04726(JsPromptResult jsPromptResult, EditText editText) {
            this.zzOi = jsPromptResult;
            this.zzOj = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C04693(jsResult)).setNegativeButton(17039360, new C04682(jsResult)).setOnCancelListener(new C04671(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C04726(jsPromptResult, editText)).setNegativeButton(17039360, new C04715(jsPromptResult)).setOnCancelListener(new C04704(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C04737.zzOk[consoleMessage.messageLevel().ordinal()]) {
