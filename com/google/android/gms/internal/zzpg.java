...
public class zzpg implements SessionsApi {
    ...
    class C11342 extends zza<SessionStopResult> {
        final /* synthetic */ String val$name;
        final /* synthetic */ zzpg zzaAs;
        final /* synthetic */ String zzaAt;

        C11342(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, String str, String str2) {
    ...
    class C11354 extends zza<SessionReadResult> {
        final /* synthetic */ zzpg zzaAs;
        final /* synthetic */ SessionReadRequest zzaAv;

        C11354(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, SessionReadRequest sessionReadRequest) {
            this.zzaAs = com_google_android_gms_internal_zzpg;
    ...
    class C13031 extends zzc {
        final /* synthetic */ Session zzaAr;
        final /* synthetic */ zzpg zzaAs;

        C13031(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, Session session) {
            this.zzaAs = com_google_android_gms_internal_zzpg;
            this.zzaAr = session;
            super(googleApiClient);
        }
    ...
    class C13043 extends zzc {
        final /* synthetic */ zzpg zzaAs;
        final /* synthetic */ SessionInsertRequest zzaAu;

        C13043(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, SessionInsertRequest sessionInsertRequest) {
            this.zzaAs = com_google_android_gms_internal_zzpg;
    ...
    class C13055 extends zzc {
        final /* synthetic */ PendingIntent zzaAl;
        final /* synthetic */ zzpg zzaAs;
        final /* synthetic */ int zzaAw;

        C13055(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, PendingIntent pendingIntent, int i) {
            this.zzaAs = com_google_android_gms_internal_zzpg;
    ...
    class C13066 extends zzc {
        final /* synthetic */ PendingIntent zzaAl;
        final /* synthetic */ zzpg zzaAs;

        C13066(zzpg com_google_android_gms_internal_zzpg, GoogleApiClient googleApiClient, PendingIntent pendingIntent) {
            this.zzaAs = com_google_android_gms_internal_zzpg;
            this.zzaAl = pendingIntent;
            super(googleApiClient);
        }
    ...
    public PendingResult<Status> startSession(GoogleApiClient client, Session session) {
        ...
        return client.zzb(new C13031(this, client, session));
    }
    ...
    public PendingResult<Status> unregisterForSessions(GoogleApiClient client, PendingIntent intent) {
        return client.zzb(new C13066(this, client, intent));
    }

    public PendingResult<Status> zza(GoogleApiClient googleApiClient, PendingIntent pendingIntent, int i) {
        return googleApiClient.zzb(new C13055(this, googleApiClient, pendingIntent, i));
    }
}
