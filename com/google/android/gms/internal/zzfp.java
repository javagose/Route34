...
public class zzfp extends zzfs {
    ...
    class C04291 implements OnClickListener {
        ...
        C04291(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class C04302 implements OnClickListener {
        ...
        C04302(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0233R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0233R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0233R.string.accept, "Accept"), new C04291(this, str, zzal));
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0233R.string.decline, "Decline"), new C04302(this));
                    zzL.create().show();
                    return;
                }
