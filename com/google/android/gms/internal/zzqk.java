...
public final class zzqk extends zzj<zzqn> {
    ...
    private static class zzb extends zzqj {
        ...
        class C08971 implements com.google.android.gms.common.api.internal.zzq.zzb<MessageListener> {
            final /* synthetic */ byte[] zzaHk;
            final /* synthetic */ String zzbbc;
            final /* synthetic */ boolean zzbbd;
            final /* synthetic */ zzb zzbbe;

            C08971(zzb com_google_android_gms_internal_zzqk_zzb, String str, byte[] bArr, boolean z) {
        ...
        class C08982 implements com.google.android.gms.common.api.internal.zzq.zzb<MessageListener> {
            final /* synthetic */ String zzbbc;
            final /* synthetic */ zzb zzbbe;

            C08982(zzb com_google_android_gms_internal_zzqk_zzb, String str) {
                this.zzbbe = com_google_android_gms_internal_zzqk_zzb;
                this.zzbbc = str;
            }
        ...
        public void onDisconnected(String remoteEndpointId) throws RemoteException {
            this.zzbbb.zza(new C08982(this, remoteEndpointId));
        }

        public void onMessageReceived(String remoteEndpointId, byte[] payload, boolean isReliable) throws RemoteException {
            this.zzbbb.zza(new C08971(this, remoteEndpointId, payload, isReliable));
        }
    }
    ...
    private static final class zze extends zzqj {
        ...
        class C09001 implements com.google.android.gms.common.api.internal.zzq.zzb<ConnectionRequestListener> {
            final /* synthetic */ byte[] zzaHk;
            final /* synthetic */ String zzbbc;
            ...
            C09001(zze com_google_android_gms_internal_zzqk_zze, String str, String str2, String str3, byte[] bArr) {
        ...
        public void onConnectionRequest(String remoteEndpointId, String remoteDeviceId, String remoteEndpointName, byte[] payload) throws RemoteException {
            this.zzbbi.zza(new C09001(this, remoteEndpointId, remoteDeviceId, remoteEndpointName, payload));
        }
    ...
    private static final class zzg extends zzqj {
        ...
        class C09011 implements com.google.android.gms.common.api.internal.zzq.zzb<EndpointDiscoveryListener> {
            ...
            C09011(zzg com_google_android_gms_internal_zzqk_zzg, String str, String str2, String str3, String str4) {
        ...
        class C09022 implements com.google.android.gms.common.api.internal.zzq.zzb<EndpointDiscoveryListener> {
            final /* synthetic */ String zzbbn;
            final /* synthetic */ zzg zzbbq;

            C09022(zzg com_google_android_gms_internal_zzqk_zzg, String str) {
                this.zzbbq = com_google_android_gms_internal_zzqk_zzg;
                this.zzbbn = str;
            }
        ...
        public void onEndpointFound(String endpointId, String deviceId, String serviceId, String name) throws RemoteException {
            this.zzbbi.zza(new C09011(this, endpointId, deviceId, serviceId, name));
        }

        public void onEndpointLost(String endpointId) throws RemoteException {
            this.zzbbi.zza(new C09022(this, endpointId));
        }
    ...
    private static final class zzd extends zzb {
        ...
        class C08991 implements com.google.android.gms.common.api.internal.zzq.zzb<ConnectionResponseCallback> {
            final /* synthetic */ byte[] zzaHk;
            final /* synthetic */ int zzadW;
            final /* synthetic */ String zzbbc;
            final /* synthetic */ zzd zzbbh;

            C08991(zzd com_google_android_gms_internal_zzqk_zzd, String str, int i, byte[] bArr) {
        ...
        public void zza(String str, int i, byte[] bArr) throws RemoteException {
            this.zzbbg.zza(new C08991(this, str, i, bArr));
        }
