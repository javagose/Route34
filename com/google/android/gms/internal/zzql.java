...
public final class zzql implements Connections {
    ...
    static class C09031 extends com.google.android.gms.common.api.Api.zza<zzqk, NoOptions> {
        C09031() {
        }
    ...
    private static abstract class zzb extends zza<StartAdvertisingResult> {
        ...
        class C10611 implements StartAdvertisingResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ zzb zzbby;

            C10611(zzb com_google_android_gms_internal_zzql_zzb, Status status) {
    ...
    class C13072 extends zzb {
        ...
        C13072(zzql com_google_android_gms_internal_zzql, GoogleApiClient googleApiClient, String str, AppMetadata appMetadata, long j, zzq com_google_android_gms_common_api_internal_zzq) {
    ...
    class C13083 extends zzc {
        final /* synthetic */ String zzbbp;
        final /* synthetic */ long zzbbs;
        final /* synthetic */ zzql zzbbu;
        final /* synthetic */ zzq zzbbv;

        C13083(zzql com_google_android_gms_internal_zzql, GoogleApiClient googleApiClient, String str, long j, zzq com_google_android_gms_common_api_internal_zzq) {
            this.zzbbu = com_google_android_gms_internal_zzql;
            this.zzbbp = str;
            this.zzbbs = j;
    ...
    class C13094 extends zzc {
        ...
        C13094(zzql com_google_android_gms_internal_zzql, GoogleApiClient googleApiClient, String str, String str2, byte[] bArr, zzq com_google_android_gms_common_api_internal_zzq, zzq com_google_android_gms_common_api_internal_zzq2) {
            this.zzbbu = com_google_android_gms_internal_zzql;
            this.val$name = str;
            this.zzbbc = str2;
            this.zzaHk = bArr;
    ...
    class C13105 extends zzc {
        final /* synthetic */ byte[] zzaHk;
        final /* synthetic */ String zzbbc;
        final /* synthetic */ zzql zzbbu;
        final /* synthetic */ zzq zzbbx;

        C13105(zzql com_google_android_gms_internal_zzql, GoogleApiClient googleApiClient, String str, byte[] bArr, zzq com_google_android_gms_common_api_internal_zzq) {
            this.zzbbu = com_google_android_gms_internal_zzql;
            this.zzbbc = str;
            this.zzaHk = bArr;
    ...
    class C13116 extends zzc {
        final /* synthetic */ String zzbbc;
        final /* synthetic */ zzql zzbbu;

        C13116(zzql com_google_android_gms_internal_zzql, GoogleApiClient googleApiClient, String str) {
            this.zzbbu = com_google_android_gms_internal_zzql;
            this.zzbbc = str;
            super(null);
        }
    ...
    public PendingResult<Status> acceptConnectionRequest(GoogleApiClient apiClient, String remoteEndpointId, byte[] payload, MessageListener messageListener) {
        return apiClient.zzb(new C13105(this, apiClient, remoteEndpointId, payload, apiClient.zzr(messageListener)));
    }
    ...
    public PendingResult<Status> rejectConnectionRequest(GoogleApiClient apiClient, String remoteEndpointId) {
        return apiClient.zzb(new C13116(this, apiClient, remoteEndpointId));
    }
    ...
    public PendingResult<Status> sendConnectionRequest(GoogleApiClient apiClient, String name, String remoteEndpointId, byte[] payload, ConnectionResponseCallback connectionResponseCallback, MessageListener messageListener) {
        return apiClient.zzb(new C13094(this, apiClient, name, remoteEndpointId, payload, apiClient.zzr(connectionResponseCallback), apiClient.zzr(messageListener)));
    }
    ...
    public PendingResult<StartAdvertisingResult> startAdvertising(GoogleApiClient apiClient, String name, AppMetadata appMetadata, long durationMillis, ConnectionRequestListener connectionRequestListener) {
        return apiClient.zzb(new C13072(this, apiClient, name, appMetadata, durationMillis, apiClient.zzr(connectionRequestListener)));
    }
    ...
    public PendingResult<Status> startDiscovery(GoogleApiClient apiClient, String serviceId, long durationMillis, EndpointDiscoveryListener listener) {
        return apiClient.zzb(new C13083(this, apiClient, serviceId, durationMillis, apiClient.zzr(listener)));
    }
