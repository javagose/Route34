...
public class zziw {
    ...
    static class C08801 implements zza {
        C08801() {
        }
    ...
    class C08812 implements com.google.android.gms.internal.zzm.zza {
        final /* synthetic */ zzc zzMA;
        final /* synthetic */ zziw zzMB;
        final /* synthetic */ String zzzP;

        C08812(zziw com_google_android_gms_internal_zziw, String str, zzc com_google_android_gms_internal_zziw_zzc) {
    ...
    private static class zzb<T> extends zzk<InputStream> {
        ...
        class C08821 implements com.google.android.gms.internal.zzm.zza {
            final /* synthetic */ com.google.android.gms.internal.zzm.zzb zzME;
            final /* synthetic */ zza zzMF;

            C08821(com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, zza com_google_android_gms_internal_zziw_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zziw_zza_T, com.google.android.gms.internal.zzm.zzb<T> com_google_android_gms_internal_zzm_zzb_T) {
            super(0, str, new C08821(com_google_android_gms_internal_zzm_zzb_T, com_google_android_gms_internal_zziw_zza_T));
    ...
    class C10563 extends zzab {
        final /* synthetic */ zziw zzMB;
        final /* synthetic */ Map zzMC;

        C10563(zziw com_google_android_gms_internal_zziw, String str, com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, com.google.android.gms.internal.zzm.zza com_google_android_gms_internal_zzm_zza, Map map) {
            this.zzMB = com_google_android_gms_internal_zziw;
            this.zzMC = map;
    ...
    public zzjg<String> zzb(String str, Map<String, String> map) {
        Object com_google_android_gms_internal_zziw_zzc = new zzc();
        zzMy.zze(new C10563(this, str, com_google_android_gms_internal_zziw_zzc, new C08812(this, str, com_google_android_gms_internal_zziw_zzc), map));
        return com_google_android_gms_internal_zziw_zzc;
    }
}
