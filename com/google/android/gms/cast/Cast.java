...
public final class Cast {
    ...
    public interface CastApi {
        ...
        public static final class zza implements CastApi {
            ...
            class C11701 extends zzh {
                final /* synthetic */ String zzZG;
                final /* synthetic */ zza zzZH;
                final /* synthetic */ String zzzW;

                C11701(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient, String str, String str2) {
            ...
            class C11712 extends zza {
                ...
                C11712(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient, String str) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
                    this.zzZI = str;
                    super(googleApiClient);
                }
            ...
            class C11723 extends zza {
                final /* synthetic */ zza zzZH;
                final /* synthetic */ String zzZI;
                final /* synthetic */ LaunchOptions zzZJ;

                C11723(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient, String str, LaunchOptions launchOptions) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
                    this.zzZI = str;
            ...
            class C11734 extends zza {
                final /* synthetic */ String val$sessionId;
                final /* synthetic */ zza zzZH;
                final /* synthetic */ String zzZI;
                final /* synthetic */ JoinOptions zzZK;

                C11734(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient, String str, String str2, JoinOptions joinOptions) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
                    this.zzZI = str;
            ...
            class C11745 extends zzh {
                final /* synthetic */ zza zzZH;

                C11745(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
                    super(googleApiClient);
                }
            ...
            class C11756 extends zzh {
                final /* synthetic */ zza zzZH;

                C11756(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
                    super(googleApiClient);
                }
            ...
            class C11767 extends zzh {
                final /* synthetic */ String val$sessionId;
                final /* synthetic */ zza zzZH;

                C11767(zza com_google_android_gms_cast_Cast_CastApi_zza, GoogleApiClient googleApiClient, String str) {
                    this.zzZH = com_google_android_gms_cast_Cast_CastApi_zza;
            ...
            public PendingResult<ApplicationConnectionResult> launchApplication(GoogleApiClient client, String applicationId) {
                return client.zzb(new C11712(this, client, applicationId));
            }
            ...
            public PendingResult<ApplicationConnectionResult> launchApplication(GoogleApiClient client, String applicationId, LaunchOptions options) {
                return client.zzb(new C11723(this, client, applicationId, options));
            }
            ...
            public PendingResult<Status> leaveApplication(GoogleApiClient client) {
                return client.zzb(new C11745(this, client));
            }
            ...
            public PendingResult<Status> sendMessage(GoogleApiClient client, String namespace, String message) {
                return client.zzb(new C11701(this, client, namespace, message));
            }
            ...
            public PendingResult<Status> stopApplication(GoogleApiClient client) {
                return client.zzb(new C11756(this, client));
            }

            public PendingResult<Status> stopApplication(GoogleApiClient client, String sessionId) {
                return client.zzb(new C11767(this, client, sessionId));
            }
            ...
            public PendingResult<ApplicationConnectionResult> zza(GoogleApiClient googleApiClient, String str, String str2, JoinOptions joinOptions) {
                return googleApiClient.zzb(new C11734(this, googleApiClient, str, str2, joinOptions));
            }
        }
    ...
    static class C07671 extends com.google.android.gms.common.api.Api.zza<zze, CastOptions> {
        C07671() {
        }
    ...
    private static abstract class zza extends com.google.android.gms.cast.internal.zzb<ApplicationConnectionResult> {
        ...
        class C09951 implements ApplicationConnectionResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ zza zzZS;

            C09951(zza com_google_android_gms_cast_Cast_zza, Status status) {
