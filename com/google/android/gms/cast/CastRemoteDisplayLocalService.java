...
public abstract class CastRemoteDisplayLocalService extends Service {
    ...
    class C03103 implements Runnable {
        ...
        C03103(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
    ...
    static class C03114 implements ServiceConnection {
        ...
        C03114(String str, CastDevice castDevice, NotificationSettings notificationSettings, Context context, Callbacks callbacks) {
            this.zzZI = str;
    ...
    class C03125 implements Runnable {
        ...
        C03125(CastRemoteDisplayLocalService castRemoteDisplayLocalService, boolean z) {
            this.zzaaz = castRemoteDisplayLocalService;
            this.zzaaE = z;
        }
    ...
    class C03136 implements Runnable {
        final /* synthetic */ NotificationSettings zzaaB;
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C03136(CastRemoteDisplayLocalService castRemoteDisplayLocalService, NotificationSettings notificationSettings) {
            this.zzaaz = castRemoteDisplayLocalService;
            this.zzaaB = notificationSettings;
        }
    ...
    class C07691 extends Callback {
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C07691(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzaaz = castRemoteDisplayLocalService;
        }
    ...
    class C07702 implements OnConnectionFailedListener {
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C07702(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzaaz = castRemoteDisplayLocalService;
        }
    ...
    class C07717 implements CastRemoteDisplaySessionCallbacks {
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C07717(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzaaz = castRemoteDisplayLocalService;
        }
    ...
    class C07728 implements ResultCallback<CastRemoteDisplaySessionResult> {
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C07728(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzaaz = castRemoteDisplayLocalService;
        }
    ...
    class C07739 implements ResultCallback<CastRemoteDisplaySessionResult> {
        final /* synthetic */ CastRemoteDisplayLocalService zzaaz;

        C07739(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzaaz = castRemoteDisplayLocalService;
        }
    ...
    static {
        ...
        zzaag = C0233R.id.cast_notification_id;
        zzaah = new Object();
    ...
    public static void startService(Context activityContext, Class<? extends CastRemoteDisplayLocalService> serviceClass, String applicationId, CastDevice device, NotificationSettings notificationSettings, Callbacks callbacks) {
        ...
        if (notificationSettings.mNotification == null && notificationSettings.zzaaF == null) {
            ...
            activityContext.bindService(intent, new C03114(applicationId, device, notificationSettings, activityContext, callbacks), 64);
        }
    }
    ...
    private void zzQ(boolean z) {
        ...
        if (Looper.myLooper() != Looper.getMainLooper()) {
            this.mHandler.post(new C03125(this, z));
        } else {
            zzR(z);
        }
    }
    ...
    private Notification zzT(boolean z) {
        ...
        if (z) {
            i = C0233R.string.cast_notification_connected_message;
            i2 = C0233R.drawable.cast_ic_notification_on;
        } else {
            i = C0233R.string.cast_notification_connecting_message;
            i2 = C0233R.drawable.cast_ic_notification_connecting;
        }
        ...
        return new Builder(this).setContentTitle(zzc).setContentText(string).setContentIntent(this.zzaan.zzaaF).setSmallIcon(i2).setOngoing(true).addAction(17301560, getString(C0233R.string.cast_notification_disconnect), zznH()).build();
    }
    ...
    private GoogleApiClient zza(CastDevice castDevice) {
        ...
        }, new C07702(this)).addApi(CastRemoteDisplay.API, new CastRemoteDisplayOptions.Builder(castDevice, this.zzaak).build()).build();
    }
    ...
    private void zznC() {
        ...
        if (this.zzaaj == null || !this.zzaaj.isConnected()) {
            ...
            CastRemoteDisplay.CastRemoteDisplayApi.startRemoteDisplay(this.zzaaj, this.zzZC).setResultCallback(new C07728(this));
        }
    }
    ...
    private void zznD() {
        ...
        if (this.zzaaj == null || !this.zzaaj.isConnected()) {
            ...
            CastRemoteDisplay.CastRemoteDisplayApi.stopRemoteDisplay(this.zzaaj).setResultCallback(new C07739(this));
        }
    }
    ...
    public void onCreate() {
        ...
        this.mHandler.postDelayed(new C03103(this), 100);
    }
    ...
    public void updateNotificationSettings(NotificationSettings notificationSettings) {
        ...
        this.mHandler.post(new C03136(this, notificationSettings));
    }
}
