...
public class RemoteMediaPlayer implements MessageReceivedCallback {
    ...
    class C10891 extends zzm {
        final /* synthetic */ RemoteMediaPlayer zzabK;

        C10891(RemoteMediaPlayer remoteMediaPlayer, String str) {
            this.zzabK = remoteMediaPlayer;
            super(str);
        }
    ...
    private static abstract class zzb extends com.google.android.gms.cast.internal.zzb<MediaChannelResult> {
        ...
        class C07741 implements zzo {
            final /* synthetic */ zzb zzacn;

            C07741(zzb com_google_android_gms_cast_RemoteMediaPlayer_zzb) {
        ...
        class C09962 implements MediaChannelResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ zzb zzacn;

            C09962(zzb com_google_android_gms_cast_RemoteMediaPlayer_zzb, Status status) {
                this.zzacn = com_google_android_gms_cast_RemoteMediaPlayer_zzb;
                this.zzZR = status;
            }
    ...
    class C11772 extends zzb {
        final /* synthetic */ RemoteMediaPlayer zzabK;
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ long[] zzabM;

        C11772(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, long[] jArr) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
            this.zzabM = jArr;
            super(googleApiClient);
    ...
    class C11783 extends zzb {
        final /* synthetic */ RemoteMediaPlayer zzabK;
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ TextTrackStyle zzabN;

        C11783(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, TextTrackStyle textTrackStyle) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
    ...
    class C11794 extends zzb {
        ...
        C11794(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, MediaQueueItem[] mediaQueueItemArr, int i, int i2, long j, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
    ...
    class C11805 extends zzb {
        ...
        C11805(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, MediaQueueItem[] mediaQueueItemArr, int i, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
    ...
    class C11816 extends zzb {
        ...
        C11816(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, MediaQueueItem mediaQueueItem, int i, long j, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
    ...
    class C11827 extends zzb {
        final /* synthetic */ RemoteMediaPlayer zzabK;
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ JSONObject zzabS;
        final /* synthetic */ MediaQueueItem[] zzabW;

        C11827(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, MediaQueueItem[] mediaQueueItemArr, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
    ...
    class C11838 extends zzb {
        final /* synthetic */ RemoteMediaPlayer zzabK;
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ JSONObject zzabS;
        final /* synthetic */ int[] zzabX;

        C11838(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
            this.zzabX = iArr;
            this.zzabS = jSONObject;
    ...
    class C11849 extends zzb {
        ...
        C11849(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, int i, JSONObject jSONObject) {
            this.zzabK = remoteMediaPlayer;
            this.zzabL = googleApiClient2;
            this.zzabY = iArr;
            this.zzabU = i;
    ...
    public RemoteMediaPlayer() {
        ...
        this.zzabE = new C10891(this, null);
    ...
    public PendingResult<MediaChannelResult> queueInsertAndPlayItem(GoogleApiClient apiClient, MediaQueueItem item, int insertBeforeItemId, long playPosition, JSONObject customData) {
        return apiClient.zzb(new C11816(this, apiClient, apiClient, item, insertBeforeItemId, playPosition, customData));
    }
    ...
    public PendingResult<MediaChannelResult> queueInsertItems(GoogleApiClient apiClient, MediaQueueItem[] itemsToInsert, int insertBeforeItemId, JSONObject customData) throws IllegalArgumentException {
        return apiClient.zzb(new C11805(this, apiClient, apiClient, itemsToInsert, insertBeforeItemId, customData));
    }
    ...
    public PendingResult<MediaChannelResult> queueLoad(GoogleApiClient apiClient, MediaQueueItem[] items, int startIndex, int repeatMode, long playPosition, JSONObject customData) throws IllegalArgumentException {
        return apiClient.zzb(new C11794(this, apiClient, apiClient, items, startIndex, repeatMode, playPosition, customData));
    }
    ...
    public PendingResult<MediaChannelResult> queueRemoveItems(GoogleApiClient apiClient, int[] itemIdsToRemove, JSONObject customData) throws IllegalArgumentException {
        return apiClient.zzb(new C11838(this, apiClient, apiClient, itemIdsToRemove, customData));
    }
    ...
    public PendingResult<MediaChannelResult> queueReorderItems(GoogleApiClient apiClient, int[] itemIdsToReorder, int insertBeforeItemId, JSONObject customData) throws IllegalArgumentException {
        return apiClient.zzb(new C11849(this, apiClient, apiClient, itemIdsToReorder, insertBeforeItemId, customData));
    }
    ...
    public PendingResult<MediaChannelResult> queueUpdateItems(GoogleApiClient apiClient, MediaQueueItem[] itemsToUpdate, JSONObject customData) {
        return apiClient.zzb(new C11827(this, apiClient, apiClient, itemsToUpdate, customData));
    }
    ...
    public PendingResult<MediaChannelResult> setActiveMediaTracks(GoogleApiClient apiClient, long[] trackIds) {
        if (trackIds != null) {
            return apiClient.zzb(new C11772(this, apiClient, apiClient, trackIds));
        }
    ...
    public PendingResult<MediaChannelResult> setTextTrackStyle(GoogleApiClient apiClient, TextTrackStyle trackStyle) {
        if (trackStyle != null) {
            return apiClient.zzb(new C11783(this, apiClient, apiClient, trackStyle));
        }
