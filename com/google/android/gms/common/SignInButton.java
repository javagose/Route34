...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    private void zza(Context context, AttributeSet attributeSet) {
        int i = SIZE_STANDARD;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0233R.styleable.SignInButton, SIZE_STANDARD, SIZE_STANDARD);
        try {
            this.mSize = obtainStyledAttributes.getInt(C0233R.styleable.SignInButton_buttonSize, SIZE_STANDARD);
            this.mColor = obtainStyledAttributes.getInt(C0233R.styleable.SignInButton_colorScheme, SIZE_ICON_ONLY);
            String string = obtainStyledAttributes.getString(C0233R.styleable.SignInButton_scopeUris);
            if (string == null) {
                this.zzafT = null;
            } else {
