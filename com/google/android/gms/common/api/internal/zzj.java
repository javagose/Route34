...
public final class zzj extends GoogleApiClient implements com.google.android.gms.common.api.internal.zzp.zza {
    ...
    class C03246 implements Runnable {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ FragmentActivity zzaih;

        C03246(zzj com_google_android_gms_common_api_internal_zzj, FragmentActivity fragmentActivity) {
    ...
    class C07841 implements zzd {
        final /* synthetic */ zzj zzaid;

        C07841(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    class C07852 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzj zzaid;

        C07852(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    class C07863 implements ConnectionCallbacks {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ AtomicReference zzaie;
        final /* synthetic */ zzv zzaif;

        C07863(zzj com_google_android_gms_common_api_internal_zzj, AtomicReference atomicReference, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
    ...
    class C07874 implements OnConnectionFailedListener {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;

        C07874(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
        }
    ...
    class C07885 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;
        final /* synthetic */ boolean zzaig;

        C07885(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv, boolean z, GoogleApiClient googleApiClient) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
            this.zzaig = z;
    ...
    public zzj(Context context, Lock lock, Looper looper, zzf com_google_android_gms_common_internal_zzf, com.google.android.gms.common.zzc com_google_android_gms_common_zzc, com.google.android.gms.common.api.Api.zza<? extends zzrn, zzro> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzrn__com_google_android_gms_internal_zzro, Map<Api<?>, Integer> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<com.google.android.gms.common.api.Api.zzc<?>, com.google.android.gms.common.api.Api.zzb> map2, int i, int i2, ArrayList<zzc> arrayList) {
        ...
        this.zzahZ = null;
        this.zzaia = null;
        this.zzaib = new C07841(this);
        this.zzaic = new C07852(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzv com_google_android_gms_common_api_internal_zzv, boolean z) {
        zzmf.zzamA.zzf(googleApiClient).setResultCallback(new C07885(this, com_google_android_gms_common_api_internal_zzv, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzahT.containsKey(zzmf.zzUI)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzmf.API).addConnectionCallbacks(new C07863(this, atomicReference, com_google_android_gms_common_api_internal_zzv)).addOnConnectionFailedListener(new C07874(this, com_google_android_gms_common_api_internal_zzv)).setHandler(this.zzahR).build();
    ...
    public void stopAutoManage(@NonNull FragmentActivity lifecycleActivity) {
        if (this.zzagp >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C03246(this, lifecycleActivity));
                return;
            } else {
                zza.zzbD(this.zzagp);
                return;
