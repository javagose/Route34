...
public class zzh implements zzk {
    ...
    class C03231 implements Runnable {
        ...
        C03231(zzh com_google_android_gms_common_api_internal_zzh) {
    ...
    private class zzb extends zzf {
        ...
        class C07821 extends zza {
            final /* synthetic */ ConnectionResult zzahF;
            final /* synthetic */ zzb zzahG;

            C07821(zzb com_google_android_gms_common_api_internal_zzh_zzb, zzk com_google_android_gms_common_api_internal_zzk, ConnectionResult connectionResult) {
        ...
        public void zzpt() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                this.zzahC.zzahj.zza(new C07821(this, this.zzahC, new ConnectionResult(isGooglePlayServicesAvailable, null)));
                return;
            }
            if (this.zzahC.zzahu) {
    ...
    private static class zzd extends com.google.android.gms.signin.internal.zzb {
        ...
        class C07831 extends zza {
            final /* synthetic */ zzh zzahI;
            final /* synthetic */ SignInResponse zzahJ;
            final /* synthetic */ zzd zzahK;

            C07831(zzd com_google_android_gms_common_api_internal_zzh_zzd, zzk com_google_android_gms_common_api_internal_zzk, zzh com_google_android_gms_common_api_internal_zzh, SignInResponse signInResponse) {
        ...
        public void zzb(SignInResponse signInResponse) {
            zzh com_google_android_gms_common_api_internal_zzh = (zzh) this.zzahD.get();
            if (com_google_android_gms_common_api_internal_zzh != null) {
                com_google_android_gms_common_api_internal_zzh.zzahj.zza(new C07831(this, com_google_android_gms_common_api_internal_zzh, com_google_android_gms_common_api_internal_zzh, signInResponse));
            }
        }
    }
    ...
    private void zzpx() {
        this.zzahj.zzpL();
        zzm.zzpN().execute(new C03231(this));
        if (this.zzahs != null) {
            if (this.zzahx) {
