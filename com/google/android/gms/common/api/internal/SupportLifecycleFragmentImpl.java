...
public class SupportLifecycleFragmentImpl extends zzw {
    ...
    class C07771 extends zzn {
        final /* synthetic */ Dialog zzaiL;
        final /* synthetic */ SupportLifecycleFragmentImpl zzaiM;

        C07771(SupportLifecycleFragmentImpl supportLifecycleFragmentImpl, Dialog dialog) {
    ...
    protected void zzc(int i, ConnectionResult connectionResult) {
        this.zzaiD = zzn.zza(getActivity().getApplicationContext(), new C07771(this, zzpS().zza(getActivity(), this)));
    }
