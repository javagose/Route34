...
public class zzg implements zzk {
    ...
    class C07801 extends zza {
        ...
        C07801(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
    ...
    class C07812 extends zza {
        final /* synthetic */ zzg zzahl;

        C07812(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
            this.zzahl = com_google_android_gms_common_api_internal_zzg;
            super(com_google_android_gms_common_api_internal_zzk);
        }
    ...
    public void connect() {
        if (this.zzahk) {
            this.zzahk = false;
            this.zzahj.zza(new C07812(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzahj.zza(new C07801(this, this));
        }
        return t;
    }
