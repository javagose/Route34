...
public abstract class zze {
    ...
    static class C07901 extends zze {
        C07901() {
        }
    ...
    static class C07912 extends zze {
        final /* synthetic */ char zzakU;
        final /* synthetic */ char zzakV;

        C07912(char c, char c2) {
            this.zzakU = c;
            this.zzakV = c2;
        }
    ...
    static class C07923 extends zze {
    ...
    static class C07934 extends zze {
        final /* synthetic */ char zzakX;
        final /* synthetic */ char zzakY;

        C07934(char c, char c2) {
            this.zzakX = c;
            this.zzakY = c2;
        }
    ...
    static class C07945 extends zze {
        C07945() {
        }
    ...
    static class C07956 extends zze {
        C07956() {
        }
    ...
    static class C07967 extends zze {
        C07967() {
        }
    ...
    static class C07978 extends zze {
        C07978() {
        }
    ...
    static class C07989 extends zze {
        C07989() {
        }
    ...
    public static zze zza(CharSequence charSequence) {
        switch (charSequence.length()) {
            ...
            case CompletionEvent.STATUS_CONFLICT /*2*/:
                return new C07912(charSequence.charAt(0), charSequence.charAt(1));
            default:
                char[] toCharArray = charSequence.toString().toCharArray();
                Arrays.sort(toCharArray);
                return new C07923(toCharArray);
        }
    }
