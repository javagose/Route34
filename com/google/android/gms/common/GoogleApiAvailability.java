...
public class GoogleApiAvailability extends zzc {
    ...
    public Dialog zza(Activity activity, OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(C0233R.string.common_google_play_services_updating_text, new Object[]{zzao}));
        builder.setTitle(C0233R.string.common_google_play_services_updating_title);
