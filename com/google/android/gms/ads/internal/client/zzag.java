...
public class zzag extends com.google.android.gms.ads.internal.client.zzs.zza {
    ...
    private class zza extends com.google.android.gms.ads.internal.client.zzr.zza {
        ...
        class C02391 implements Runnable {
            ...
            C02391(zza com_google_android_gms_ads_internal_client_zzag_zza) {
        ...
        public void zzf(AdRequestParcel adRequestParcel) throws RemoteException {
            zzb.m13e("This app is using a lightweight version of the Google Mobile Ads SDK that requires the latest Google Play services to be installed, but Google Play services is either missing or out of date.");
            com.google.android.gms.ads.internal.util.client.zza.zzMS.post(new C02391(this));
        }
    }
