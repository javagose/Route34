...
public abstract class zzc extends zzb implements zzg, zzft {
    ...
    class C02602 implements Runnable {
        ...
        C02602(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza) {
    ...
    class C02633 implements Runnable {
        ...
        class C02611 implements OnTouchListener {
            final /* synthetic */ zze zzpu;
            final /* synthetic */ C02633 zzpv;

            C02611(C02633 c02633, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c02633;
        ...
        class C02622 implements OnClickListener {
            ...
            C02622(C02633 c02633, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c02633;
                this.zzpu = com_google_android_gms_ads_internal_zze;
            }
        ...
        C02633(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C02611(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C02622(this, com_google_android_gms_ads_internal_zze));
    ...
    class C07431 implements zzdf {
        final /* synthetic */ zzc zzpr;

        C07431(zzc com_google_android_gms_ads_internal_zzc) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
        }
    ...
    protected void zza(zzeh com_google_android_gms_internal_zzeh) {
        com_google_android_gms_internal_zzeh.zza("/trackActiveViewUnit", new C07431(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C02602(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzif_zza.zzLe.zzHT || com_google_android_gms_internal_zzif_zza.zzLe.zzum) {
            zzir.zzMc.post(new C02633(this, com_google_android_gms_internal_zzif_zza, com_google_android_gms_internal_zzcb));
            return;
        }
        this.zzpj.zzrL = 0;
