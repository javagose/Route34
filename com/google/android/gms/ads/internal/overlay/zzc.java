...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C02431 implements Runnable {
        ...
        C02431(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C02442 implements Runnable {
        ...
        C02442(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02453 implements Runnable {
        ...
        C02453(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzEe = str;
            this.zzEf = str2;
        }
    ...
    class C02464 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02464(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02475 implements Runnable {
        ...
        C02475(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02486 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02486(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02497 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02497(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C02442(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzw(-1);
        zzx(-1);
        zzir.zzMc.post(new C02453(this, str, str2));
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C02431(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        zzfa();
        zzir.zzMc.post(new C02464(this));
    }
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        ...
        zzir.zzMc.post(new C02475(this));
        zzv(true);
        return true;
    }
    ...
    public void pause() {
        ...
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C02497(this));
        }
        zzx(4);
    }
    ...
    public void play() {
        ...
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C02486(this));
        }
        zzx(3);
    }
