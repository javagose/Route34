...
public class zzi implements zzh {
    ...
    class C07321 implements zzdf {
        final /* synthetic */ zzi zzyx;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzi.1.1 */
        class C07311 implements zzjq.zza {
            final /* synthetic */ Map zzyy;
            final /* synthetic */ C07321 zzyz;

            C07311(C07321 c07321, Map map) {
                this.zzyz = c07321;
                this.zzyy = map;
            }
        ...
        C07321(zzi com_google_android_gms_ads_internal_formats_zzi) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
            this.zzyx.zzpD.zzhU().zza(new C07311(this, map));
    ...
    class C07332 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C07332(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C07343 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C07343(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C07354 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C07354(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C07365 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C07365(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    public zzjp zzdR() {
        ...
        this.zzyr.zza("/loadHtml", new C07321(this));
        this.zzyr.zza("/showOverlay", new C07332(this));
        this.zzyr.zza("/hideOverlay", new C07343(this));
        this.zzpD.zzhU().zza("/hideOverlay", new C07354(this));
        this.zzpD.zzhU().zza("/sendMessageToSdk", new C07365(this));
        return this.zzpD;
    }
