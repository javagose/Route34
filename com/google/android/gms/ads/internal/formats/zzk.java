...
public class zzk extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C02421 implements Runnable {
        ...
        C02421(zzk com_google_android_gms_ads_internal_formats_zzk, zzi com_google_android_gms_ads_internal_formats_zzi) {
    ...
    public void zza(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpV) {
            ...
            if (zzp instanceof zzi) {
                ...
                zzir.zzMc.post(new C02421(this, com_google_android_gms_ads_internal_formats_zzi));
