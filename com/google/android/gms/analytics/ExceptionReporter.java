...
public class ExceptionReporter implements UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, UncaughtExceptionHandler originalHandler, Context context) {
        if (tracker == null) {
            ...
            zzae.m14v("ExceptionReporter created, original handler is " + (originalHandler == null ? "null" : originalHandler.getClass().getName()));
        }
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        zzae.m14v("Reporting uncaught exception: " + str);
        ...
        zziC.zziG();
        if (this.zzPa != null) {
            zzae.m14v("Passing exception to the original handler");
