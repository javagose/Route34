...
public class Tracker extends zzd {
    ...
    class C02781 implements Runnable {
        ...
        C02781(Tracker tracker, Map map, boolean z, String str, long j, boolean z2, boolean z3, String str2) {
            this.zzPF = tracker;
            this.zzPy = map;
            this.zzPz = z;
            this.zzPA = str;
    ...
    public void send(Map<String, String> params) {
        ...
        zzjo().zzf(new C02781(this, hashMap, zziL, str, currentTimeMillis, isDryRunEnabled, zzh, str2));
    }
