...
public abstract class GcmListenerService extends Service {
    ...
    class C03681 implements Runnable {
        ...
        C03681(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C03692 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaLA;

        C03692(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaLA = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    private void zzn(Intent intent) {
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C03681(this, intent));
        } else {
            new C03692(this, intent).execute(new Void[0]);
        }
    }
