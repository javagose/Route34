...
class zzm extends zzj<zzf> {
    ...
    class C09171 extends zzg<StatusCallback, zze> {
        final /* synthetic */ zzm zzbcz;

        C09171(zzm com_google_android_gms_nearby_messages_internal_zzm) {
    ...
    class C09182 extends zzg<MessageListener, zzc> {
        final /* synthetic */ zzm zzbcz;

        C09182(zzm com_google_android_gms_nearby_messages_internal_zzm) {
            this.zzbcz = com_google_android_gms_nearby_messages_internal_zzm;
            super();
        }
    ...
    private static class zzc extends com.google.android.gms.nearby.messages.internal.zzd.zza implements zza<MessageListener> {
        ...
        class C09191 implements com.google.android.gms.common.api.internal.zzq.zzb<MessageListener> {
            final /* synthetic */ MessageWrapper zzbcC;
            final /* synthetic */ zzc zzbcD;

            C09191(zzc com_google_android_gms_nearby_messages_internal_zzm_zzc, MessageWrapper messageWrapper) {
        ...
        class C09202 implements com.google.android.gms.common.api.internal.zzq.zzb<MessageListener> {
            final /* synthetic */ zzc zzbcD;
            final /* synthetic */ MessageWrapper[] zzbcE;

            C09202(zzc com_google_android_gms_nearby_messages_internal_zzm_zzc, MessageWrapper[] messageWrapperArr) {
                this.zzbcD = com_google_android_gms_nearby_messages_internal_zzm_zzc;
        ...
        class C09213 implements com.google.android.gms.common.api.internal.zzq.zzb<MessageListener> {
            final /* synthetic */ zzc zzbcD;
            final /* synthetic */ MessageWrapper zzbcF;

            C09213(zzc com_google_android_gms_nearby_messages_internal_zzm_zzc, MessageWrapper messageWrapper) {
                this.zzbcD = com_google_android_gms_nearby_messages_internal_zzm_zzc;
    ...
    private static class zze extends com.google.android.gms.nearby.messages.internal.zzh.zza implements zza<StatusCallback> {
        ...
        class C09221 implements com.google.android.gms.common.api.internal.zzq.zzb<StatusCallback> {
            final /* synthetic */ boolean zzbcI;
            final /* synthetic */ zze zzbcJ;

            C09221(zze com_google_android_gms_nearby_messages_internal_zzm_zze, boolean z) {
        ...
        public void onPermissionChanged(boolean granted) {
            this.zzbcH.zza(new C09221(this, granted));
        }
    ...
    zzm(Context context, Looper looper, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener, com.google.android.gms.common.internal.zzf com_google_android_gms_common_internal_zzf, MessagesOptions messagesOptions) {
        ...
        this.zzbcx = new C09171(this);
        this.zzbcy = new C09182(this);
