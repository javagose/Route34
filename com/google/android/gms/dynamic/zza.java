...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    static class C03365 implements OnClickListener {
        final /* synthetic */ int zzAe;
        final /* synthetic */ Context zzxh;

        C03365(Context context, int i) {
            this.zzxh = context;
            this.zzAe = i;
        }
    ...
    class C08031 implements zzf<T> {
        final /* synthetic */ zza zzavB;

        C08031(zza com_google_android_gms_dynamic_zza) {
    ...
    class C08042 implements zza {
        ...
        C08042(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    class C08053 implements zza {
        ...
        C08053(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
            this.zzavD = bundle;
        }
    ...
    class C08064 implements zza {
        ...
        C08064(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    class C08076 implements zza {
        final /* synthetic */ zza zzavB;

        C08076(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    class C08087 implements zza {
        final /* synthetic */ zza zzavB;

        C08087(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    public static void zzb(FrameLayout frameLayout) {
        ...
        if (zzh != null) {
            ...
            button.setOnClickListener(new C03365(context, isGooglePlayServicesAvailable));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new C08053(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new C08064(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzavx == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new C08042(this, activity, attrs, savedInstanceState));
    }
