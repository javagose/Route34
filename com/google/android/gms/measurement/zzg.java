...
public final class zzg {
    ...
    class C05291 implements Runnable {
        ...
        C05291(zzg com_google_android_gms_measurement_zzg, zzc com_google_android_gms_measurement_zzc) {
    ...
    private class zza extends ThreadPoolExecutor {
        ...
        class C05301 extends FutureTask<T> {
            final /* synthetic */ zza zzaUC;

            C05301(zza com_google_android_gms_measurement_zzg_zza, Runnable runnable, Object obj) {
        ...
        protected <T> RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
            return new C05301(this, runnable, value);
        }
    }
    ...
    void zze(zzc com_google_android_gms_measurement_zzc) {
        if (com_google_android_gms_measurement_zzc.zzAD()) {
            ...
            zzAu.zzAA();
            this.zzaUy.execute(new C05291(this, zzAu));
        }
    }
