...
public class zzp extends zzz {
    ...
    class C05161 implements Runnable {
        ...
        C05161(zzp com_google_android_gms_measurement_internal_zzp, String str) {
    ...
    public void zzb(int i, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzCU == null) {
            ...
            zzCU.zzg(new C05161(this, str2.length() > Barcode.UPC_E ? str.substring(0, Barcode.UPC_E) : str2));
        }
    }
