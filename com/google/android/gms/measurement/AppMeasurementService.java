...
public final class AppMeasurementService extends Service {
    ...
    class C04971 implements Runnable {
        ...
        C04971(AppMeasurementService appMeasurementService, zzw com_google_android_gms_measurement_internal_zzw, int i, zzp com_google_android_gms_measurement_internal_zzp) {
        ...
        public void run() {
            this.zzaTW.zzDc();
            this.zzaTY.mHandler.post(new C04961(this));
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzaT.zzCn().zzg(new C04971(this, zzaT, startId, zzAo));
        }
        return 2;
    }
