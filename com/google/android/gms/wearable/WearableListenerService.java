...
public abstract class WearableListenerService extends Service implements CapabilityListener, ChannelListener, DataListener, MessageListener, NodeListener, com.google.android.gms.wearable.NodeApi.zza {
    ...
    private final class zza extends com.google.android.gms.wearable.internal.zzaw.zza {
        ...
        class C05811 implements Runnable {
            ...
            C05811(zza com_google_android_gms_wearable_WearableListenerService_zza, DataHolder dataHolder) {
        ...
        class C05822 implements Runnable {
            ...
            C05822(zza com_google_android_gms_wearable_WearableListenerService_zza, MessageEventParcelable messageEventParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        class C05833 implements Runnable {
            ...
            C05833(zza com_google_android_gms_wearable_WearableListenerService_zza, NodeParcelable nodeParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        class C05844 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ NodeParcelable zzbru;

            C05844(zza com_google_android_gms_wearable_WearableListenerService_zza, NodeParcelable nodeParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
                this.zzbru = nodeParcelable;
            }
        ...
        class C05855 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ List zzbrv;

            C05855(zza com_google_android_gms_wearable_WearableListenerService_zza, List list) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
                this.zzbrv = list;
            }
        ...
        class C05866 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ CapabilityInfoParcelable zzbrw;

            C05866(zza com_google_android_gms_wearable_WearableListenerService_zza, CapabilityInfoParcelable capabilityInfoParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        class C05877 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ AncsNotificationParcelable zzbrx;

            C05877(zza com_google_android_gms_wearable_WearableListenerService_zza, AncsNotificationParcelable ancsNotificationParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        class C05888 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ AmsEntityUpdateParcelable zzbry;

            C05888(zza com_google_android_gms_wearable_WearableListenerService_zza, AmsEntityUpdateParcelable amsEntityUpdateParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        class C05899 implements Runnable {
            final /* synthetic */ zza zzbrs;
            final /* synthetic */ ChannelEventParcelable zzbrz;

            C05899(zza com_google_android_gms_wearable_WearableListenerService_zza, ChannelEventParcelable channelEventParcelable) {
                this.zzbrs = com_google_android_gms_wearable_WearableListenerService_zza;
        ...
        public void onConnectedNodes(List<NodeParcelable> connectedNodes) {
            zzb(new C05855(this, connectedNodes), "onConnectedNodes", connectedNodes);
        }

        public void zza(AmsEntityUpdateParcelable amsEntityUpdateParcelable) {
            zza(new C05888(this, amsEntityUpdateParcelable), "onEntityUpdate", amsEntityUpdateParcelable);
        }

        public void zza(AncsNotificationParcelable ancsNotificationParcelable) {
            zza(new C05877(this, ancsNotificationParcelable), "onNotificationReceived", ancsNotificationParcelable);
        }

        public void zza(CapabilityInfoParcelable capabilityInfoParcelable) {
            zzb(new C05866(this, capabilityInfoParcelable), "onConnectedCapabilityChanged", capabilityInfoParcelable);
        }

        public void zza(ChannelEventParcelable channelEventParcelable) {
            zzb(new C05899(this, channelEventParcelable), "onChannelEvent", channelEventParcelable);
        }

        public void zza(MessageEventParcelable messageEventParcelable) {
            zzb(new C05822(this, messageEventParcelable), "onMessageReceived", messageEventParcelable);
        }

        public void zza(NodeParcelable nodeParcelable) {
            zzb(new C05833(this, nodeParcelable), "onPeerConnected", nodeParcelable);
        }

        public void zzag(DataHolder dataHolder) {
            try {
                if (!zzb(new C05811(this, dataHolder), "onDataItemChanged", dataHolder)) {
                }
            } finally {
                dataHolder.close();
            }
        ...
        public void zzb(NodeParcelable nodeParcelable) {
            zzb(new C05844(this, nodeParcelable), "onPeerDisconnected", nodeParcelable);
        }
    }
