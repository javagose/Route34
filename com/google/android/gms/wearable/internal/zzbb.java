...
public final class zzbb implements NodeApi {
    ...
    static class C09493 implements zza<NodeListener> {
        final /* synthetic */ IntentFilter[] zzbrP;

        C09493(IntentFilter[] intentFilterArr) {
    ...
    class C11541 extends zzi<GetLocalNodeResult> {
        final /* synthetic */ zzbb zzbsU;

        C11541(zzbb com_google_android_gms_wearable_internal_zzbb, GoogleApiClient googleApiClient) {
    ...
    class C11552 extends zzi<GetConnectedNodesResult> {
        final /* synthetic */ zzbb zzbsU;

        C11552(zzbb com_google_android_gms_wearable_internal_zzbb, GoogleApiClient googleApiClient) {
            this.zzbsU = com_google_android_gms_wearable_internal_zzbb;
            super(googleApiClient);
        }
    ...
    class C11564 extends zzi<Status> {
        final /* synthetic */ zzbb zzbsU;
        final /* synthetic */ NodeListener zzbsV;

        C11564(zzbb com_google_android_gms_wearable_internal_zzbb, GoogleApiClient googleApiClient, NodeListener nodeListener) {
            this.zzbsU = com_google_android_gms_wearable_internal_zzbb;
    ...
    private static zza<NodeListener> zza(IntentFilter[] intentFilterArr) {
        return new C09493(intentFilterArr);
    }
