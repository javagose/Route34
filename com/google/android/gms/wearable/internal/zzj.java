...
public class zzj implements CapabilityApi {
    ...
    static class C09595 implements zza<CapabilityListener> {
        final /* synthetic */ IntentFilter[] zzbrP;

        C09595(IntentFilter[] intentFilterArr) {
    ...
    class C11571 extends zzi<GetCapabilityResult> {
        final /* synthetic */ String zzbrM;
        final /* synthetic */ int zzbrN;
        final /* synthetic */ zzj zzbrO;

        C11571(zzj com_google_android_gms_wearable_internal_zzj, GoogleApiClient googleApiClient, String str, int i) {
    ...
    class C11582 extends zzi<GetAllCapabilitiesResult> {
        final /* synthetic */ int zzbrN;
        final /* synthetic */ zzj zzbrO;

        C11582(zzj com_google_android_gms_wearable_internal_zzj, GoogleApiClient googleApiClient, int i) {
            this.zzbrO = com_google_android_gms_wearable_internal_zzj;
            this.zzbrN = i;
            super(googleApiClient);
        }
    ...
    class C11593 extends zzi<AddLocalCapabilityResult> {
        final /* synthetic */ String zzbrM;
        final /* synthetic */ zzj zzbrO;

        C11593(zzj com_google_android_gms_wearable_internal_zzj, GoogleApiClient googleApiClient, String str) {
            this.zzbrO = com_google_android_gms_wearable_internal_zzj;
            this.zzbrM = str;
            super(googleApiClient);
        }
    ...
    class C11604 extends zzi<RemoveLocalCapabilityResult> {
        final /* synthetic */ String zzbrM;
        final /* synthetic */ zzj zzbrO;

        C11604(zzj com_google_android_gms_wearable_internal_zzj, GoogleApiClient googleApiClient, String str) {
            this.zzbrO = com_google_android_gms_wearable_internal_zzj;
            this.zzbrM = str;
            super(googleApiClient);
        }
    ...
    private static zza<CapabilityListener> zza(IntentFilter[] intentFilterArr) {
        return new C09595(intentFilterArr);
    }
    ...
    public PendingResult<AddLocalCapabilityResult> addLocalCapability(GoogleApiClient client, String capability) {
        return client.zza(new C11593(this, client, capability));
    }
    ...
    public PendingResult<GetAllCapabilitiesResult> getAllCapabilities(GoogleApiClient client, int nodeFilter) {
        ...
        zzx.zzac(z);
        return client.zza(new C11582(this, client, nodeFilter));
    }
    ...
    public PendingResult<GetCapabilityResult> getCapability(GoogleApiClient client, String capability, int nodeFilter) {
        ...
        zzx.zzac(z);
        return client.zza(new C11571(this, client, capability, nodeFilter));
    }
    ...
    public PendingResult<RemoveLocalCapabilityResult> removeLocalCapability(GoogleApiClient client, String capability) {
        return client.zza(new C11604(this, client, capability));
    }
}
