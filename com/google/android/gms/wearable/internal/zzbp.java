...
public class zzbp extends zzj<zzax> {
    ...
    class C05901 implements Callable<Boolean> {
        final /* synthetic */ byte[] zzbsP;
        final /* synthetic */ ParcelFileDescriptor zzbtm;
        final /* synthetic */ zzbp zzbtn;

        C05901(zzbp com_google_android_gms_wearable_internal_zzbp, ParcelFileDescriptor parcelFileDescriptor, byte[] bArr) {
...
*/
    ...
    class C05912 implements Runnable {
        ...
        C05912(zzbp com_google_android_gms_wearable_internal_zzbp, Uri uri, zzb com_google_android_gms_common_api_internal_zza_zzb, boolean z, String str) {
            this.zzbtn = com_google_android_gms_wearable_internal_zzbp;
            this.zzbds = uri;
    ...
    class C05923 implements Runnable {
        ...
        C05923(zzbp com_google_android_gms_wearable_internal_zzbp, Uri uri, zzb com_google_android_gms_common_api_internal_zza_zzb, String str, long j, long j2) {
            this.zzbtn = com_google_android_gms_wearable_internal_zzbp;
            this.zzbds = uri;
            this.zzbto = com_google_android_gms_common_api_internal_zza_zzb;
            this.zzVj = str;
    ...
    private FutureTask<Boolean> zza(ParcelFileDescriptor parcelFileDescriptor, byte[] bArr) {
        return new FutureTask(new C05901(this, parcelFileDescriptor, bArr));
    }
    ...
    private Runnable zzb(zzb<Status> com_google_android_gms_common_api_internal_zza_zzb_com_google_android_gms_common_api_Status, String str, Uri uri, long j, long j2) {
        ...
        return new C05923(this, uri, com_google_android_gms_common_api_internal_zza_zzb_com_google_android_gms_common_api_Status, str, j, j2);
    }
    ...
    private Runnable zzb(zzb<Status> com_google_android_gms_common_api_internal_zza_zzb_com_google_android_gms_common_api_Status, String str, Uri uri, boolean z) {
        ...
        zzx.zzz(str);
        zzx.zzz(uri);
        return new C05912(this, uri, com_google_android_gms_common_api_internal_zza_zzb_com_google_android_gms_common_api_Status, z, str);
    }
