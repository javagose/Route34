...
public class ChannelImpl implements SafeParcelable, Channel {
    ...
    static class C09487 implements zza<ChannelListener> {
        final /* synthetic */ String zzVj;
        final /* synthetic */ IntentFilter[] zzbrP;

        C09487(String str, IntentFilter[] intentFilterArr) {
            this.zzVj = str;
    ...
    class C11461 extends zzi<Status> {
        final /* synthetic */ ChannelImpl zzbsd;

        C11461(ChannelImpl channelImpl, GoogleApiClient googleApiClient) {
    ...
    class C11472 extends zzi<Status> {
        final /* synthetic */ int zzAe;
        final /* synthetic */ ChannelImpl zzbsd;

        C11472(ChannelImpl channelImpl, GoogleApiClient googleApiClient, int i) {
            this.zzbsd = channelImpl;
            this.zzAe = i;
            super(googleApiClient);
        }
    ...
    class C11483 extends zzi<GetInputStreamResult> {
        final /* synthetic */ ChannelImpl zzbsd;

        C11483(ChannelImpl channelImpl, GoogleApiClient googleApiClient) {
            this.zzbsd = channelImpl;
            super(googleApiClient);
        }
    ...
    class C11494 extends zzi<GetOutputStreamResult> {
        final /* synthetic */ ChannelImpl zzbsd;

        C11494(ChannelImpl channelImpl, GoogleApiClient googleApiClient) {
            this.zzbsd = channelImpl;
            super(googleApiClient);
        }
    ...
    class C11505 extends zzi<Status> {
        final /* synthetic */ Uri zzbds;
        final /* synthetic */ ChannelImpl zzbsd;
        final /* synthetic */ boolean zzbse;

        C11505(ChannelImpl channelImpl, GoogleApiClient googleApiClient, Uri uri, boolean z) {
            this.zzbsd = channelImpl;
            this.zzbds = uri;
            this.zzbse = z;
            super(googleApiClient);
    ...
    class C11516 extends zzi<Status> {
        final /* synthetic */ Uri zzbds;
        final /* synthetic */ ChannelImpl zzbsd;
        final /* synthetic */ long zzbsf;
        final /* synthetic */ long zzbsg;

        C11516(ChannelImpl channelImpl, GoogleApiClient googleApiClient, Uri uri, long j, long j2) {
            this.zzbsd = channelImpl;
            this.zzbds = uri;
            this.zzbsf = j;
            this.zzbsg = j2;
    ...
    private static zza<ChannelListener> zza(String str, IntentFilter[] intentFilterArr) {
        return new C09487(str, intentFilterArr);
    }
    ...
    public PendingResult<Status> close(GoogleApiClient client) {
        return client.zza(new C11461(this, client));
    }

    public PendingResult<Status> close(GoogleApiClient client, int errorCode) {
        return client.zza(new C11472(this, client, errorCode));
    }
    ...
    public PendingResult<GetInputStreamResult> getInputStream(GoogleApiClient client) {
        return client.zza(new C11483(this, client));
    }
    ...
    public PendingResult<GetOutputStreamResult> getOutputStream(GoogleApiClient client) {
        return client.zza(new C11494(this, client));
    }
    ...
    public PendingResult<Status> receiveFile(GoogleApiClient client, Uri uri, boolean append) {
        ...
        return client.zza(new C11505(this, client, uri, append));
    }
    ...
    public PendingResult<Status> sendFile(GoogleApiClient client, Uri uri, long startOffset, long length) {
        ...
        return client.zza(new C11516(this, client, uri, startOffset, length));
    }
