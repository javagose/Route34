...
public class StreetViewPanorama {
    ...
    class C10761 extends zza {
        final /* synthetic */ OnStreetViewPanoramaChangeListener zzaSs;
        final /* synthetic */ StreetViewPanorama zzaSt;

        C10761(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaChangeListener onStreetViewPanoramaChangeListener) {
    ...
    class C10772 extends zzw.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaCameraChangeListener zzaSu;

        C10772(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaCameraChangeListener onStreetViewPanoramaCameraChangeListener) {
            this.zzaSt = streetViewPanorama;
    ...
    class C10783 extends zzy.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaClickListener zzaSv;

        C10783(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaClickListener onStreetViewPanoramaClickListener) {
            this.zzaSt = streetViewPanorama;
    ...
    class C10794 extends zzz.zza {
        final /* synthetic */ StreetViewPanorama zzaSt;
        final /* synthetic */ OnStreetViewPanoramaLongClickListener zzaSw;

        C10794(StreetViewPanorama streetViewPanorama, OnStreetViewPanoramaLongClickListener onStreetViewPanoramaLongClickListener) {
            this.zzaSt = streetViewPanorama;
    ...
    public final void setOnStreetViewPanoramaCameraChangeListener(OnStreetViewPanoramaCameraChangeListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaCameraChangeListener(new C10772(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaChangeListener(OnStreetViewPanoramaChangeListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaChangeListener(new C10761(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaClickListener(OnStreetViewPanoramaClickListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaClickListener(new C10783(this, listener));
    }
    ...
    public final void setOnStreetViewPanoramaLongClickListener(OnStreetViewPanoramaLongClickListener listener) {
        ...
        this.zzaSr.setOnStreetViewPanoramaLongClickListener(new C10794(this, listener));
    }
