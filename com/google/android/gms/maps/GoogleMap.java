...
public final class GoogleMap {
    ...
    class AnonymousClass11 extends com.google.android.gms.maps.internal.ILocationSourceDelegate.zza {
        ...
        class C09091 implements OnLocationChangedListener {
            final /* synthetic */ zzk zzaRF;
            final /* synthetic */ AnonymousClass11 zzaRG;

            C09091(AnonymousClass11 anonymousClass11, zzk com_google_android_gms_maps_internal_zzk) {
        ...
        public void activate(zzk listener) {
            this.zzaRE.activate(new C09091(this, listener));
        }
    ...
    class C10651 extends com.google.android.gms.maps.internal.zzg.zza {
        final /* synthetic */ OnIndoorStateChangeListener zzaRt;
        final /* synthetic */ GoogleMap zzaRu;

        C10651(GoogleMap googleMap, OnIndoorStateChangeListener onIndoorStateChangeListener) {
            this.zzaRu = googleMap;
    ...
    class C10662 extends com.google.android.gms.maps.internal.zzi.zza {
        final /* synthetic */ GoogleMap zzaRu;
        final /* synthetic */ OnInfoWindowCloseListener zzaRv;

        C10662(GoogleMap googleMap, OnInfoWindowCloseListener onInfoWindowCloseListener) {
            this.zzaRu = googleMap;
    ...
    class C10673 extends com.google.android.gms.maps.internal.zzd.zza {
        final /* synthetic */ GoogleMap zzaRu;
        final /* synthetic */ InfoWindowAdapter zzaRw;

        C10673(GoogleMap googleMap, InfoWindowAdapter infoWindowAdapter) {
            this.zzaRu = googleMap;
    ...
    class C10684 extends com.google.android.gms.maps.internal.zzs.zza {
        final /* synthetic */ GoogleMap zzaRu;
        final /* synthetic */ OnMyLocationChangeListener zzaRx;

        C10684(GoogleMap googleMap, OnMyLocationChangeListener onMyLocationChangeListener) {
            this.zzaRu = googleMap;
    ...
    class C10695 extends com.google.android.gms.maps.internal.zzr.zza {
        final /* synthetic */ GoogleMap zzaRu;
        final /* synthetic */ OnMyLocationButtonClickListener zzaRy;

        C10695(GoogleMap googleMap, OnMyLocationButtonClickListener onMyLocationButtonClickListener) {
            this.zzaRu = googleMap;
    ...
    class C10706 extends com.google.android.gms.maps.internal.zzm.zza {
        final /* synthetic */ GoogleMap zzaRu;
        final /* synthetic */ OnMapLoadedCallback zzaRz;

        C10706(GoogleMap googleMap, OnMapLoadedCallback onMapLoadedCallback) {
            this.zzaRu = googleMap;
    ...
    class C10717 extends com.google.android.gms.maps.internal.zzf.zza {
        final /* synthetic */ OnGroundOverlayClickListener zzaRA;
        final /* synthetic */ GoogleMap zzaRu;

        C10717(GoogleMap googleMap, OnGroundOverlayClickListener onGroundOverlayClickListener) {
            this.zzaRu = googleMap;
    ...
    class C10728 extends com.google.android.gms.maps.internal.zzu.zza {
        final /* synthetic */ OnPolygonClickListener zzaRB;
        final /* synthetic */ GoogleMap zzaRu;

        C10728(GoogleMap googleMap, OnPolygonClickListener onPolygonClickListener) {
            this.zzaRu = googleMap;
    ...
    class C10739 extends com.google.android.gms.maps.internal.zzv.zza {
        final /* synthetic */ OnPolylineClickListener zzaRC;
        final /* synthetic */ GoogleMap zzaRu;

        C10739(GoogleMap googleMap, OnPolylineClickListener onPolylineClickListener) {
            this.zzaRu = googleMap;
    ...
    public final void setInfoWindowAdapter(InfoWindowAdapter adapter) {
        ...
        this.zzaRr.setInfoWindowAdapter(new C10673(this, adapter));
    }
    ...
    public final void setOnGroundOverlayClickListener(OnGroundOverlayClickListener listener) {
        ...
        this.zzaRr.setOnGroundOverlayClickListener(new C10717(this, listener));
    }
    ...
    public final void setOnIndoorStateChangeListener(OnIndoorStateChangeListener listener) {
        ...
        this.zzaRr.setOnIndoorStateChangeListener(new C10651(this, listener));
    }
    ...
    public final void setOnInfoWindowCloseListener(OnInfoWindowCloseListener listener) {
        ...
        this.zzaRr.setOnInfoWindowCloseListener(new C10662(this, listener));
    }
    ...
    public void setOnMapLoadedCallback(OnMapLoadedCallback callback) {
        ...
        this.zzaRr.setOnMapLoadedCallback(new C10706(this, callback));
    }
    ...
    public final void setOnMyLocationButtonClickListener(OnMyLocationButtonClickListener listener) {
        ...
        this.zzaRr.setOnMyLocationButtonClickListener(new C10695(this, listener));
    }
    ...
    public final void setOnMyLocationChangeListener(OnMyLocationChangeListener listener) {
        ...
        this.zzaRr.setOnMyLocationChangeListener(new C10684(this, listener));
    }
    ...
    public final void setOnPolygonClickListener(OnPolygonClickListener listener) {
        ...
        this.zzaRr.setOnPolygonClickListener(new C10728(this, listener));
    }
    ...
    public final void setOnPolylineClickListener(OnPolylineClickListener listener) {
        ...
        this.zzaRr.setOnPolylineClickListener(new C10739(this, listener));
    }
