...
class zzba<K, V> implements zzl<K, V> {
    ...
    class C05481 extends LruCache<K, V> {
        final /* synthetic */ zza zzbjr;
        final /* synthetic */ zzba zzbjs;

        C05481(zzba com_google_android_gms_tagmanager_zzba, int i, zza com_google_android_gms_tagmanager_zzm_zza) {
    ...
    zzba(int i, zza<K, V> com_google_android_gms_tagmanager_zzm_zza_K__V) {
        this.zzbjq = new C05481(this, i, com_google_android_gms_tagmanager_zzm_zza_K__V);
    }
