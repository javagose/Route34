...
class zzj extends zzdd {
    ...
    class C09421 implements zza {
        final /* synthetic */ Context zzxh;

        C09421(Context context) {
            this.zzxh = context;
        }
    ...
    public zzj(Context context) {
        this(context, new C09421(context));
    }
                ...
                if (zzl instanceof List) {
                    for (Object zzl2 : (List) zzl2) {
                        if (zzl2 instanceof Map) {
                            ...
                            zzbg.m15e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + buildUpon.build().toString());
                            return;
                        }
                    }
                }
                zzbg.m15e("ArbitraryPixel: additional params not a list: not sending partial hit: " + buildUpon.build().toString());
                return;
            }
            String uri = buildUpon.build().toString();
            this.zzbhJ.zzFX().zzgc(uri);
            zzbg.m16v("ArbitraryPixel: url = " + uri);
            if (zzg != null) {
