...
public class zzdg extends zzdd {
    ...
    private void zza(Tracker tracker, Map<String, zza> map) {
        ...
        if (zzgy == null) {
            zzbg.m15e("Cannot find transactionId in data layer.");
            return;
        }
            ...
            if (zzgz != null) {
                for (Map map2 : zzgz) {
                    if (map2.get("name") == null) {
                        zzbg.m15e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            if (obj instanceof List) {
                for (Map map4 : (List) obj) {
                    try {
                        ...
                        zzbg.m15e("Failed to extract a product from DataLayer. " + e.getMessage());
                    }
                }
            }
            ...
            if (r0 != null) {
                for (Map map42 : r0) {
                    try {
                        ...
                        zzbg.m15e("Failed to extract a promotion from DataLayer. " + e2.getMessage());
                    }
                }
                                ...
                                if (list != null) {
                                    for (Map map22 : list) {
                                        try {
                                            ...
                                            zzbg.m15e("Failed to extract a product from DataLayer. " + e3.getMessage());
                                        }
                                    }
                                }
                                try {
                                    ...
                                    zzbg.m15e("Failed to extract a product action from DataLayer. " + e22.getMessage());
                                }
                            }
                        }
                    }
