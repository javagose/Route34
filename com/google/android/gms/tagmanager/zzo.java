...
class zzo implements ContainerHolder {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case CompletionEvent.STATUS_FAILURE /*1*/:
                    zzfV((String) msg.obj);
                default:
                    zzbg.m15e("Don't know how to handle this message.");
            }
        }
    ...
    public synchronized Container getContainer() {
        ...
        synchronized (this) {
            if (this.zzapK) {
                zzbg.m15e("ContainerHolder is released.");
            } else {
                if (this.zzbhV != null) {
    ...
    String getContainerId() {
        ...
        zzbg.m15e("getContainerId called on a released ContainerHolder.");
    ...
    public synchronized void refresh() {
        if (this.zzapK) {
            zzbg.m15e("Refreshing a released ContainerHolder.");
        } else {
            this.zzbhX.zzGf();
        }
    }
    ...
    public synchronized void release() {
        if (this.zzapK) {
            zzbg.m15e("Releasing a released ContainerHolder.");
        } else {
            this.zzapK = true;
            this.zzbhY.zzb(this);
            this.zzbhU.release();
    ...
    String zzGd() {
        ...
        zzbg.m15e("setCtfeUrlPathAndQuery called on a released ContainerHolder.");
        return BuildConfig.FLAVOR;
    }
    ...
    public synchronized void zza(Container container) {
        if (!this.zzapK) {
            if (container == null) {
                zzbg.m15e("Unexpected null container.");
            } else {
