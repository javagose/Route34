...
class zzat extends Thread implements zzas {
    ...
    class C05461 implements Runnable {
        ...
        C05461(zzat com_google_android_gms_tagmanager_zzat, zzas com_google_android_gms_tagmanager_zzas, long j, String str) {
    ...
    public void run() {
        while (!this.mClosed) {
            try {
                ...
                zzbg.m15e("Error on Google TagManager Thread: " + zzd(th));
                zzbg.m15e("Google TagManager is shutting down.");
                this.zzRE = true;
            }
        }
    }
    ...
    void zzk(String str, long j) {
        zzj(new C05461(this, this, j, str));
    }
}
