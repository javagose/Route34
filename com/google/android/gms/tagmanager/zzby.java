...
class zzby implements zzau {
    ...
    class zza implements com.google.android.gms.tagmanager.zzcx.zza {
        ...
        public void zzb(zzaq com_google_android_gms_tagmanager_zzaq) {
            this.zzbjK.zzq(com_google_android_gms_tagmanager_zzaq.zzGD());
            zzbg.m16v("Permanent failure dispatching hitId: " + com_google_android_gms_tagmanager_zzaq.zzGD());
        }
        ...
        public void zzc(zzaq com_google_android_gms_tagmanager_zzaq) {
            ...
            if (zzGE == 0) {
                ...
                this.zzbjK.zzq(com_google_android_gms_tagmanager_zzaq.zzGD());
                zzbg.m16v("Giving up on failed hitId: " + com_google_android_gms_tagmanager_zzaq.zzGD());
            }
        }
    }
    ...
    private void zzGQ() {
        ...
        if (zzGR > 0) {
            List zzkl = zzkl(zzGR);
            zzbg.m16v("Store full, deleting " + zzkl.size() + " hits to make room.");
    ...
    public void dispatch() {
        zzbg.m16v("GTM Dispatch running...");
        if (this.zzbjF.zzGw()) {
            List zzkm = zzkm(40);
            if (zzkm.isEmpty()) {
                zzbg.m16v("...nothing to dispatch");
