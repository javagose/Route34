...
public class zzdf {
    ...
    private static double getDouble(Object o) {
        ...
        zzbg.m15e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    public static zza zzR(Object obj) {
        ...
        if (obj instanceof String) {
            ...
            zzbg.m15e("Converting to Value from unknown object type: " + (obj == null ? "null" : obj.getClass().toString()));
            return zzblM;
        }
    ...
    private static long zzU(Object obj) {
        ...
        zzbg.m15e("getInt64 received non-Number");
        return 0;
    }
    ...
    private static zzde zzgu(String str) {
        try {
            ...
            zzbg.m15e("Failed to convert '" + str + "' to a number.");
            return zzblH;
        }
    }
        ...
        switch (com_google_android_gms_internal_zzag_zza.type) {
            ...
            case CompletionEvent.STATUS_CANCELED /*3*/:
                if (com_google_android_gms_internal_zzag_zza.zzjz.length != com_google_android_gms_internal_zzag_zza.zzjA.length) {
                    zzbg.m15e("Converting an invalid value to object: " + com_google_android_gms_internal_zzag_zza.toString());
                    return zzblE;
                }
            ...
            case Barcode.PHONE /*4*/:
                zzbg.m15e("Trying to convert a macro reference to object");
                return zzblE;
            case Barcode.PRODUCT /*5*/:
                zzbg.m15e("Trying to convert a function id to object");
                return zzblE;
            case Barcode.SMS /*6*/:
            ...
            default:
                zzbg.m15e("Failed to convert a value of type: " + com_google_android_gms_internal_zzag_zza.type);
                return zzblE;
        }
    }
}
