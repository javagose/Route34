...
public class zzp extends com.google.android.gms.common.api.internal.zzb<ContainerHolder> {
    ...
    class C09442 implements com.google.android.gms.tagmanager.zzo.zza {
        final /* synthetic */ zzp zzbim;

        C09442(zzp com_google_android_gms_tagmanager_zzp) {
    ...
    class C09453 implements zza {
        final /* synthetic */ zzp zzbim;
        final /* synthetic */ boolean zzbin;

        C09453(zzp com_google_android_gms_tagmanager_zzp, boolean z) {
            this.zzbim = com_google_android_gms_tagmanager_zzp;
            this.zzbin = z;
        }
            ...
            synchronized (this.zzbim) {
                if (com_google_android_gms_internal_zzaf_zzj.zzju == null) {
                    if (this.zzbim.zzbii.zzju == null) {
                        zzbg.m15e("Current resource is null; network resource is also null");
                        this.zzbim.zzak(3600000);
                        return;
                    }
                ...
                zzbg.m16v("setting refresh time to current time: " + this.zzbim.zzbhR);
                if (!this.zzbim.zzGj()) {
    ...
    public void zzGg() {
        com.google.android.gms.internal.zzrs.zzc zzke = this.zzbie.zzke(this.zzbid);
        if (zzke != null) {
            zza(new zzo(this.zzbhY, this.zzagr, new Container(this.mContext, this.zzbhY.getDataLayer(), this.zzbhM, 0, zzke), new C09442(this)));
        } else {
    ...
    protected ContainerHolder zzbn(Status status) {
        ...
        if (status == Status.zzagF) {
            zzbg.m15e("timer expired: setting result to failure");
        }
