...
public class Container {
    ...
    private void zza(zzf com_google_android_gms_internal_zzaf_zzf) {
        ...
        try {
            ...
            zzbg.m15e("Not loading resource: " + com_google_android_gms_internal_zzaf_zzf + " because it is invalid: " + e.toString());
        }
    }
    ...
    public boolean getBoolean(String key) {
        zzcp zzGc = zzGc();
        if (zzGc == null) {
            zzbg.m15e("getBoolean called for closed container.");
        ...
        try {
            ...
            zzbg.m15e("Calling getBoolean() threw an exception: " + e.getMessage() + " Returning default value.");
            return zzdf.zzHC().booleanValue();
        }
    }
    ...
    public double getDouble(String key) {
        zzcp zzGc = zzGc();
        if (zzGc == null) {
            zzbg.m15e("getDouble called for closed container.");
            return zzdf.zzHB().doubleValue();
        }
        try {
            return zzdf.zzj((com.google.android.gms.internal.zzag.zza) zzGc.zzgn(key).getObject()).doubleValue();
        } catch (Exception e) {
            zzbg.m15e("Calling getDouble() threw an exception: " + e.getMessage() + " Returning default value.");
            return zzdf.zzHB().doubleValue();
        }
    }
    ...
    public long getLong(String key) {
        zzcp zzGc = zzGc();
        if (zzGc == null) {
            zzbg.m15e("getLong called for closed container.");
            return zzdf.zzHA().longValue();
        }
        try {
            return zzdf.zzi((com.google.android.gms.internal.zzag.zza) zzGc.zzgn(key).getObject()).longValue();
        } catch (Exception e) {
            zzbg.m15e("Calling getLong() threw an exception: " + e.getMessage() + " Returning default value.");
            return zzdf.zzHA().longValue();
        }
    }
    ...
    public String getString(String key) {
        zzcp zzGc = zzGc();
        if (zzGc == null) {
            zzbg.m15e("getString called for closed container.");
            return zzdf.zzHE();
        }
        try {
            return zzdf.zzg((com.google.android.gms.internal.zzag.zza) zzGc.zzgn(key).getObject());
        } catch (Exception e) {
            zzbg.m15e("Calling getString() threw an exception: " + e.getMessage() + " Returning default value.");
            return zzdf.zzHE();
        }
    }
