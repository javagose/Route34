...
public final class Games {
    ...
    static class C10011 extends GamesClientBuilder {
        C10011() {
            super();
        }
    ...
    static class C10022 extends GamesClientBuilder {
        C10022() {
            super();
        }
    ...
    static class C11176 extends BaseGamesApiMethodImpl<LoadExperimentsResult> {

        /* renamed from: com.google.android.gms.games.Games.6.1 */
        class C10031 implements LoadExperimentsResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ C11176 zzaCD;

            C10031(C11176 c11176, Status status) {
                this.zzaCD = c11176;
                this.zzZR = status;
            }
    ...
    private static abstract class GetServerAuthCodeImpl extends BaseGamesApiMethodImpl<GetServerAuthCodeResult> {
        ...
        class C10041 implements GetServerAuthCodeResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ GetServerAuthCodeImpl zzaCM;

            C10041(GetServerAuthCodeImpl getServerAuthCodeImpl, Status status) {
    ...
    private static abstract class GetTokenImpl extends BaseGamesApiMethodImpl<GetTokenResult> {
        ...
        class C10051 implements GetTokenResult {
            final /* synthetic */ Status zzZR;
            final /* synthetic */ GetTokenImpl zzaCN;

            C10051(GetTokenImpl getTokenImpl, Status status) {
    ...
    static class C12093 extends GetTokenImpl {
        protected void zza(GamesClientImpl gamesClientImpl) throws RemoteException {
    ...
    static class C12104 extends GetServerAuthCodeImpl {
        final /* synthetic */ String zzaCC;

        C12104(GoogleApiClient x0, String str) {
            this.zzaCC = str;
            super(null);
        }
    ...
    static class C12115 extends SignOutImpl {
        C12115(GoogleApiClient x0) {
            super(null);
        }
    ...
    public static PendingResult<GetServerAuthCodeResult> getGamesServerAuthCode(GoogleApiClient apiClient, String serverClientId) {
        ...
        return apiClient.zzb(new C12104(apiClient, serverClientId));
    }
    ...
    public static PendingResult<Status> signOut(GoogleApiClient apiClient) {
        return apiClient.zzb(new C12115(apiClient));
    }
