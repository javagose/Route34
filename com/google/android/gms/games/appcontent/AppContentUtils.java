...
public final class AppContentUtils {
    ...
    static class C08091 implements AppContentRunner {
        final /* synthetic */ ArrayList zzaDR;

        C08091(ArrayList arrayList) {
    ...
    static class C08102 implements AppContentRunner {
        final /* synthetic */ ArrayList zzaDR;

        C08102(ArrayList arrayList) {
            this.zzaDR = arrayList;
        }
    ...
    static class C08113 implements AppContentRunner {
        final /* synthetic */ ArrayList zzaDR;

        C08113(ArrayList arrayList) {
            this.zzaDR = arrayList;
        }
    ...
    static class C08124 implements AppContentRunner {
        final /* synthetic */ DataHolder zzaDS;
        final /* synthetic */ Bundle zzaDT;

        C08124(DataHolder dataHolder, Bundle bundle) {
    ...
    public static ArrayList<AppContentAction> zza(DataHolder dataHolder, ArrayList<DataHolder> arrayList, String str, int i) {
        ...
        String str2 = str;
        zza(dataHolder2, 1, str2, "action_id", i, new C08091(arrayList2), arrayList);
        return arrayList2;
    }
    ...
    public static ArrayList<AppContentAnnotation> zzb(DataHolder dataHolder, ArrayList<DataHolder> arrayList, String str, int i) {
        ...
        DataHolder dataHolder2 = dataHolder;
        String str2 = str;
        zza(dataHolder2, 2, str2, "annotation_id", i, new C08102(arrayList2), arrayList);
        return arrayList2;
    }
    ...
    public static ArrayList<AppContentCondition> zzc(DataHolder dataHolder, ArrayList<DataHolder> arrayList, String str, int i) {
        ...
        DataHolder dataHolder2 = dataHolder;
        String str2 = str;
        zza(dataHolder2, 4, str2, "condition_id", i, new C08113(arrayList2), arrayList);
        return arrayList2;
    }
    ...
    public static Bundle zzd(DataHolder dataHolder, ArrayList<DataHolder> arrayList, String str, int i) {
        ...
        DataHolder dataHolder2 = dataHolder;
        String str2 = str;
        zza(dataHolder2, 3, str2, "tuple_id", i, new C08124((DataHolder) arrayList.get(3), bundle), arrayList);
        return bundle;
    }
}
