...
public final class AclsImpl implements Acls {
    ...
    static class C10081 implements LoadAclResult {
        final /* synthetic */ Status zzZR;

        C10081(Status status) {
            this.zzZR = status;
        }
    ...
    class C12212 extends LoadNotifyAclImpl {
    ...
    class C12223 extends UpdateNotifyAclImpl {
