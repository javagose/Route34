...
public final class CameraConfigurationUtils {
    ...
    public static void setBestPreviewFPS(Parameters parameters, int minFPS, int maxFPS) {
        ...
        if (supportedPreviewFpsRanges != null && !supportedPreviewFpsRanges.isEmpty()) {
            ...
            for (int[] fpsRange : supportedPreviewFpsRanges) {
                ...
                if (thisMin >= minFPS * GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE && thisMax <= maxFPS * GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE) {
    ...
    private static Integer indexOfClosestZoom(Parameters parameters, double targetZoomRatio) {
        ...
        double smallestDiff = MediaQueueItem.DEFAULT_PLAYBACK_DURATION;
        int closestIndex = 0;
    ...
    public static String collectStats(CharSequence flattenedParams) {
        StringBuilder result = new StringBuilder(GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE);
