...
final class DecodedBitStreamParser {
    ...
    static /* synthetic */ class C06001 {
        static final /* synthetic */ int[] f9xb73eb560;

        static {
            f9xb73eb560 = new int[Mode.values().length];
            try {
                f9xb73eb560[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f9xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f9xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f9xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f9xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
    ...
    static DecoderResult decode(byte[] bytes) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                switch (C06001.f9xb73eb560[mode.ordinal()]) {
                    ...
                    switch (shift) {
                        case Barcode.ALL_FORMATS /*0*/:
                            if (cValue < 3) {
                                ...
                                result.append((char) (c40char + Barcode.ITF));
                                upperShift = false;
                                break;
                            } else {
                                throw FormatException.getFormatInstance();
                        ...
                        case CompletionEvent.STATUS_FAILURE /*1*/:
                            if (upperShift) {
                                result.append((char) (cValue + Barcode.ITF));
                                upperShift = false;
                            } else {
                    ...
                    switch (shift) {
                        case Barcode.ALL_FORMATS /*0*/:
                            if (cValue < 3) {
                                ...
                                result.append((char) (textChar + Barcode.ITF));
                                upperShift = false;
                                break;
                            } else {
                                throw FormatException.getFormatInstance();
    ...
    private static int unrandomize255State(int randomizedBase256Codeword, int base256CodewordPosition) {
        ...
        return tempVariable >= 0 ? tempVariable : tempVariable + Barcode.QR_CODE;
    }
}
