...
public final class Code93Reader extends OneDReader {
    ...
    static {
        ...
        CHARACTER_ENCODINGS = new int[]{276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, 420, 418, WalletConstants.ERROR_CODE_INVALID_PARAMETERS, WalletConstants.ERROR_CODE_SERVICE_UNAVAILABLE, 394, 360, 356, 354, 308, 282, 344, 332, 326, Strategy.TTL_SECONDS_DEFAULT, 278, 436, 434, 428, 422, WalletConstants.ERROR_CODE_SPENDING_LIMIT_EXCEEDED, WalletConstants.ERROR_CODE_INVALID_TRANSACTION, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, 306, 350};
    ...
    private static String decodeExtended(CharSequence encoded) throws FormatException {
        ...
        while (i < length) {
            ...
            if (c < 'a' || c > 'd') {
                ...
                char decodedChar = '\u0000';
                switch (c) {
                    case C0232R.styleable.Theme_buttonBarNegativeButtonStyle /*97*/:
                        if (next >= 'A' && next <= 'Z') {
                        ...
                        throw FormatException.getFormatInstance();
                        break;
                    case C0232R.styleable.Theme_buttonBarNeutralButtonStyle /*98*/:
                        if (next < 'A' || next > 'E') {
                            if (next < 'F' || next > 'J') {
                                if (next < 'K' || next > 'O') {
                                    if (next < 'P' || next > 'S') {
                        ...
                        break;
                        break;
                    case C0232R.styleable.Theme_autoCompleteTextViewStyle /*99*/:
                        if (next >= 'A' && next <= 'O') {
