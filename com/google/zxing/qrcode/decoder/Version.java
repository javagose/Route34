...
public final class Version {
    ...
    static Version decodeVersionInformation(int versionBits) {
        int bestDifference = Strategy.TTL_SECONDS_INFINITE;
        int bestVersion = 0;
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(1, C0232R.styleable.Theme_spinnerStyle));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, C0232R.styleable.Theme_seekBarStyle));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, C0232R.styleable.Theme_seekBarStyle), new ECB(5, C0232R.styleable.Theme_spinnerStyle));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, C0232R.styleable.Theme_seekBarStyle), new ECB(5, C0232R.styleable.Theme_spinnerStyle));
        ...
        iArr = new int[]{6, 30, 54, 78, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, C0232R.styleable.Theme_ratingBarStyle};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, C0232R.styleable.Theme_ratingBarStyle), new ECB(4, C0232R.styleable.Theme_seekBarStyle));
        ...
        iArr = new int[]{6, 30, 54, 78, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, TransportMediator.KEYCODE_MEDIA_PLAY};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 52, 78, LocationRequest.PRIORITY_LOW_POWER, TransportMediator.KEYCODE_MEDIA_RECORD};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 56, 82, C0232R.styleable.Theme_spinnerStyle, 134};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, TransportMediator.KEYCODE_MEDIA_PLAY, 150};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 24, 50, 76, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, Barcode.ITF, 154};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, C0232R.styleable.Theme_ratingBarStyle, 132, 158};
        eCBlocksArr = new ECBlocks[4];
