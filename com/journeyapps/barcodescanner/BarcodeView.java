...
public class BarcodeView extends CameraPreview {
    ...
    class C06091 implements Callback {
        C06091() {
        }

        public boolean handleMessage(Message message) {
            if (message.what == C0599R.id.zxing_decode_succeeded) {
                ...
                return true;
            } else if (message.what == C0599R.id.zxing_decode_failed) {
                return true;
            } else {
                if (message.what != C0599R.id.zxing_possible_result_points) {
                    return false;
                }
    ...
    public BarcodeView(Context context) {
        ...
        this.callback = null;
        this.resultCallback = new C06091();
