...
public class ViewfinderView extends View {
    ...
    class C09691 implements StateListener {
        C09691() {
        }
    ...
    static {
        ...
        SCANNER_ALPHA = new int[]{0, 64, Barcode.ITF, 192, MotionEventCompat.ACTION_MASK, 192, Barcode.ITF, 64};
    }
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = getContext().obtainStyledAttributes(attrs, C0599R.styleable.zxing_finder);
        this.maskColor = attributes.getColor(C0599R.styleable.zxing_finder_zxing_viewfinder_mask, resources.getColor(C0599R.color.zxing_viewfinder_mask));
        this.resultColor = attributes.getColor(C0599R.styleable.zxing_finder_zxing_result_view, resources.getColor(C0599R.color.zxing_result_view));
        this.laserColor = attributes.getColor(C0599R.styleable.zxing_finder_zxing_viewfinder_laser, resources.getColor(C0599R.color.zxing_viewfinder_laser));
        this.resultPointColor = attributes.getColor(C0599R.styleable.zxing_finder_zxing_possible_result_points, resources.getColor(C0599R.color.zxing_possible_result_points));
        attributes.recycle();
        this.scannerAlpha = 0;
    ...
    public void setCameraPreview(CameraPreview view) {
        ...
        view.addStateListener(new C09691());
    }
