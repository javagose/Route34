...
public class CameraPreview extends ViewGroup {
    ...
    class C06101 implements SurfaceTextureListener {
        C06101() {
        }
    ...
    class C06112 implements SurfaceHolder.Callback {
        C06112() {
        }
    ...
    class C06123 implements Callback {
        C06123() {
        }

        public boolean handleMessage(Message message) {
            if (message.what == C0599R.id.zxing_prewiew_size_ready) {
                CameraPreview.this.previewSized((Size) message.obj);
                return true;
            }
            if (message.what == C0599R.id.zxing_camera_error) {
    ...
    class C09644 implements RotationCallback {
        ...
        public void onRotationChanged(int rotation) {
            CameraPreview.this.stateHandler.postDelayed(new C06131(), 250);
        }
    }

    /* renamed from: com.journeyapps.barcodescanner.CameraPreview.5 */
    class C09655 implements StateListener {
        C09655() {
        }
    ...
    public CameraPreview(Context context) {
        ...
        this.torchOn = false;
        this.surfaceCallback = new C06112();
        this.stateCallback = new C06123();
        this.rotationCallback = new C09644();
        this.fireState = new C09655();
    ...
    protected void initializeAttributes(AttributeSet attrs) {
        TypedArray styledAttributes = getContext().obtainStyledAttributes(attrs, C0599R.styleable.zxing_camera_preview);
        int framingRectWidth = (int) styledAttributes.getDimension(C0599R.styleable.zxing_camera_preview_zxing_framing_rect_width, GroundOverlayOptions.NO_DIMENSION);
        int framingRectHeight = (int) styledAttributes.getDimension(C0599R.styleable.zxing_camera_preview_zxing_framing_rect_height, GroundOverlayOptions.NO_DIMENSION);
        if (framingRectWidth > 0 && framingRectHeight > 0) {
            this.framingRectSize = new Size(framingRectWidth, framingRectHeight);
        }
        this.useTextureView = styledAttributes.getBoolean(C0599R.styleable.zxing_camera_preview_zxing_use_texture_view, true);
        int scalingStrategyNumber = styledAttributes.getInteger(C0599R.styleable.zxing_camera_preview_zxing_preview_scaling_strategy, -1);
    ...
    protected Matrix calculateTextureTransform(Size textureSize, Size previewSize) {
        ...
        if (ratioTexture < ratioPreview) {
            ...
            scaleX = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
