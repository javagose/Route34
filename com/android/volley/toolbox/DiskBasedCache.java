...
public class DiskBasedCache implements Cache {
    ...
    public synchronized void initialize() {
        ...
        r13 = this;
        monitor-enter(r13);
        r9 = r13.mRootDirectory;	 Catch:{ all -> 0x0069 }
        r9 = r9.exists();	 Catch:{ all -> 0x0069 }
        if (r9 != 0) goto L_0x0024;
    L_0x0009:
        r9 = r13.mRootDirectory;	 Catch:{ all -> 0x0069 }
        r9 = r9.mkdirs();	 Catch:{ all -> 0x0069 }
        if (r9 != 0) goto L_0x0022;
    L_0x0011:
        r9 = "Unable to create cache dir %s";
        r10 = 1;
        r10 = new java.lang.Object[r10];	 Catch:{ all -> 0x0069 }
        r11 = 0;
        r12 = r13.mRootDirectory;	 Catch:{ all -> 0x0069 }
        r12 = r12.getAbsolutePath();	 Catch:{ all -> 0x0069 }
        r10[r11] = r12;	 Catch:{ all -> 0x0069 }
        com.android.volley.VolleyLog.m10e(r9, r10);	 Catch:{ all -> 0x0069 }
    L_0x0022:
        monitor-exit(r13);
        return;
    L_0x0024:
        r9 = r13.mRootDirectory;	 Catch:{ all -> 0x0069 }
        r4 = r9.listFiles();	 Catch:{ all -> 0x0069 }
        if (r4 == 0) goto L_0x0022;
    L_0x002c:
        r0 = r4;
        r8 = r0.length;	 Catch:{ all -> 0x0069 }
        r7 = 0;
    L_0x002f:
        if (r7 >= r8) goto L_0x0022;
    L_0x0031:
        r3 = r0[r7];	 Catch:{ all -> 0x0069 }
        r5 = 0;
        r6 = new java.io.FileInputStream;	 Catch:{ IOException -> 0x0054 }
        r6.<init>(r3);	 Catch:{ IOException -> 0x0054 }
        r2 = com.android.volley.toolbox.DiskBasedCache.CacheHeader.readHeader(r6);	 Catch:{ IOException -> 0x0071, all -> 0x006e }
        r10 = r3.length();	 Catch:{ IOException -> 0x0071, all -> 0x006e }
        r2.size = r10;	 Catch:{ IOException -> 0x0071, all -> 0x006e }
        r9 = r2.key;	 Catch:{ IOException -> 0x0071, all -> 0x006e }
        r13.putEntry(r9, r2);	 Catch:{ IOException -> 0x0071, all -> 0x006e }
