...
public class ImageLoader {
    ...
    class C07242 implements Listener<Bitmap> {
    ...
    class C07253 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C09911(errorImageResId, view, defaultImageResId);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight) {
        ...
        Request<?> newRequest = new ImageRequest(requestUrl, new C07242(cacheKey), maxWidth, maxHeight, Config.RGB_565, new C07253(cacheKey));
