...
public class ViewFinderView extends View implements IViewFinder {
    ...
    public ViewFinderView(Context context) {
        super(context);
        this.mDefaultLaserColor = getResources().getColor(C0635R.color.viewfinder_laser);
        this.mDefaultMaskColor = getResources().getColor(C0635R.color.viewfinder_mask);
        this.mDefaultBorderColor = getResources().getColor(C0635R.color.viewfinder_border);
        this.mDefaultBorderStrokeWidth = getResources().getInteger(C0635R.integer.viewfinder_border_width);
        this.mDefaultBorderLineLength = getResources().getInteger(C0635R.integer.viewfinder_border_length);
        init();
    }
