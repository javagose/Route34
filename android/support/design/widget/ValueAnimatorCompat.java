...
class ValueAnimatorCompat {
    ...
    class C06611 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C06611(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C06622 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C06622(AnimatorListener animatorListener) {
    ...
    public void setUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.setUpdateListener(new C06611(updateListener));
        } else {
    ...
    public void setListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.setListener(new C06622(listener));
        } else {
