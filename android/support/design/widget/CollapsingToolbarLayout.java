...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C06431 implements OnApplyWindowInsetsListener {
        C06431() {
        }
    ...
    class C06442 implements AnimatorUpdateListener {
        C06442() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06431());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C06442());
