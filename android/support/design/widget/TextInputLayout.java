...
public class TextInputLayout extends LinearLayout {
    ...
    class C06604 implements AnimatorUpdateListener {
        C06604() {
        }
    ...
    class C09732 extends ViewPropertyAnimatorListenerAdapter {
        C09732() {
        }
    ...
    class C09743 extends ViewPropertyAnimatorListenerAdapter {
        C09743() {
        }
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            ViewCompat.animate(this.mErrorView).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C09732()).start();
            this.mErrorShown = true;
            updateEditTextBackground();
            updateLabelVisibility(true);
        } else if (this.mErrorView.getVisibility() == 0) {
            ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C09743()).start();
            this.mErrorShown = false;
            updateEditTextBackground();
        }
    }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C06604());
            }
