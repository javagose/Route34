...
class FloatingActionButtonHoneycombMr1 extends FloatingActionButtonEclairMr1 {
    ...
    void show(@Nullable InternalVisibilityChangedListener listener) {
        ...
        this.mView.animate().scaleX(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).scaleY(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00042(listener));
    }
