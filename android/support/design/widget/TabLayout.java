...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C06591 implements AnimatorUpdateListener {
            ...
            C06591(int i, int i2, int i3, int i4) {
        ...
        class C09722 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C06591(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C09722(position));
                animator.start();
    ...
    class C06582 implements AnimatorUpdateListener {
        C06582() {
        }
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C06582());
                }
