...
public class AsyncListUtil<T> {
    ...
    class C07031 implements MainThreadCallback<T> {
        C07031() {
        }
    ...
    class C07042 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C07031();
        this.mBackgroundCallback = new C07042();
        this.mTClass = klass;
