...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C07051 implements MainThreadCallback<T> {
        ...
        class C01701 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C07051.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C07051.UPDATE_ITEM_COUNT /*1*/:
                            C07051.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C07051.ADD_TILE /*2*/:
                            C07051.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C07051.REMOVE_TILE /*3*/:
                            C07051.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C07051.this.mQueue.next();
                }
            }
        }

        C07051(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01701();
        }
    ...
    class C07062 implements BackgroundCallback<T> {
        ...
        class C01711 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C07062.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C07062.REFRESH /*1*/:
                                C07062.this.mQueue.removeMessages(C07062.REFRESH);
                                C07062.this.val$callback.refresh(msg.arg1);
                                break;
                            case C07062.UPDATE_RANGE /*2*/:
                                C07062.this.mQueue.removeMessages(C07062.UPDATE_RANGE);
                                C07062.this.mQueue.removeMessages(C07062.LOAD_TILE);
                                C07062.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C07062.LOAD_TILE /*3*/:
                                C07062.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C07062.RECYCLE_TILE /*4*/:
                                C07062.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C07062.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C07062(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01711();
        }
