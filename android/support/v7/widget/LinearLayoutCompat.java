...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0153R.styleable.LinearLayoutCompat, defStyleAttr, SHOW_DIVIDER_NONE);
        ...
        this.mWeightSum = a.getFloat(C0153R.styleable.LinearLayoutCompat_android_weightSum, GroundOverlayOptions.NO_DIMENSION);
        ...
        this.mShowDividers = a.getInt(C0153R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = a.getDimensionPixelSize(C0153R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        a.recycle();
    }
