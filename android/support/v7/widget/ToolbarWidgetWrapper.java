...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C09892 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0153R.string.abc_action_bar_up_description, C0153R.drawable.abc_ic_ab_back_mtrl_am_alpha);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        if (style) {
            ...
            Drawable navIcon = a.getDrawable(C0153R.styleable.ActionBar_homeAsUpIndicator);
            if (navIcon != null) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C02151());
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f).setDuration(duration).setListener(new C09892(visibility));
    }
