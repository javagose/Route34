...
public class ListPopupWindow {
    ...
    class C07111 extends ForwardingListener {
        C07111(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0153R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0153R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0153R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
