...
public class Toolbar extends ViewGroup {
    ...
    class C02133 implements OnClickListener {
        C02133() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C02141 implements Creator<SavedState> {
            C02141() {
            }
    ...
    class C07191 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C07191() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C07191();
        this.mShowOverflowMenuRunnable = new C02122();
        ...
        int dimensionPixelOffset = a.getDimensionPixelOffset(C0153R.styleable.Toolbar_titleMargins, 0);
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0153R.styleable.Toolbar_contentInsetStart, LinearLayoutManager.INVALID_OFFSET);
        int contentInsetEnd = a.getDimensionPixelOffset(C0153R.styleable.Toolbar_contentInsetEnd, LinearLayoutManager.INVALID_OFFSET);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), null, C0153R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), null, C0153R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02133());
        }
    }
