...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C07101 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C07101(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01841 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C01841(AppCompatSpinner appCompatSpinner) {
        ...
        class C01863 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01863(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01841(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01852();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01863(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0153R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0153R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0153R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C07101(this, popup);
            }
        }
        a.recycle();
        this.mPopupSet = true;
