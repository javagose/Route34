...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01801 extends DataSetObserver {
        C01801() {
        }
    ...
    class C01824 extends DataSetObserver {
        C01824() {
        }
    ...
    class C07093 extends ForwardingListener {
        C07093(View x0) {
            super(x0);
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C01801();
        this.mOnGlobalLayoutListener = new C01812();
        ...
        expandButton.setOnTouchListener(new C07093(expandButton));
        ...
        this.mAdapter.registerDataSetObserver(new C01824());
