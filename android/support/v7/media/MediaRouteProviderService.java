...
public abstract class MediaRouteProviderService extends Service {
    ...
    class C06981 extends ControlRequestCallback {
        ...
        C06981(ClientRecord clientRecord, int i, Intent intent, Messenger messenger, int i2) {
    ...
    private boolean onRouteControlRequest(Messenger messenger, int requestId, int controllerId, Intent intent) {
        ...
        if (client != null) {
            ...
            if (controller != null) {
                ...
                if (requestId != 0) {
                    callback = new C06981(client, controllerId, intent, messenger, requestId);
                }
