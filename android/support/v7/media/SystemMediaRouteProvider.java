...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements Callback, VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C0168R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        private void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, r.getString(C0168R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(PLAYBACK_STREAM).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(maxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
