...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01441 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & Barcode.AZTEC) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0232R.styleable.Theme_spinnerStyle);
            }
    ...
    class C01455 implements Runnable {
        ...
        class C09751 extends ViewPropertyAnimatorListenerAdapter {
            C09751() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C09751());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C06941 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C06941() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C06941());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            TypedArray a = context2.obtainStyledAttributes(C0153R.styleable.Theme);
            this.background = a.getResourceId(C0153R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0153R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
    ...
    class C06912 implements OnApplyWindowInsetsListener {
        C06912() {
        }
    ...
    class C06923 implements OnFitSystemWindowsListener {
        C06923() {
        }
    ...
    class C06934 implements OnAttachListener {
        C06934() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0232R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C09771());
            }
    ...
    class C09766 extends ViewPropertyAnimatorListenerAdapter {
        C09766() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0232R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0153R.styleable.Theme);
        if (a.hasValue(C0153R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0153R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0153R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(C0232R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(C0153R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0232R.styleable.Theme_switchStyle);
            }
            if (a.getBoolean(C0153R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0153R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C06912());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C06923());
                }
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0232R.styleable.Theme_switchStyle);
                }
            ...
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0153R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new C06934());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0153R.styleable.Theme);
        a.getValue(C0153R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0153R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0153R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0153R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0153R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0153R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0153R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0153R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0153R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0153R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0232R.styleable.Theme_spinnerStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case Barcode.GEO /*10*/:
                ...
                return true;
            case C0232R.styleable.Theme_spinnerStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0232R.styleable.Theme_switchStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0232R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C09766());
                    if (this.mActionModePopup != null) {
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0232R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0232R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0232R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0232R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0232R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0232R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0232R.styleable.Theme_spinnerStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0232R.styleable.Theme_switchStyle;
        }
    }
