...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C06973 implements ViewPropertyAnimatorUpdateListener {
        C06973() {
        }
    ...
    class C09781 extends ViewPropertyAnimatorListenerAdapter {
        C09781() {
        }
    ...
    class C09792 extends ViewPropertyAnimatorListenerAdapter {
        C09792() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C09781();
        this.mShowListener = new C09792();
        this.mUpdateListener = new C06973();
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0153R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
